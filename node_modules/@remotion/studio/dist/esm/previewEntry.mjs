...
import React173, { useCallback as useCallback130, useEffect as useEffect76, useMemo as useMemo128 } from "react";
...
import { useCallback as useCallback93, useMemo as useMemo97, useState as useState62 } from "react";
...
import { useCallback as useCallback91, useContext as useContext57, useEffect as useEffect57 } from "react";

// src/components/TopPanel.tsx
import { useCallback as useCallback90, useContext as useContext56, useEffect as useEffect56, useMemo as useMemo95 } from "react";
...
// src/error-overlay/remotion-overlay/Overlay.tsx
import {
...
var setErrorsRef = createRef8();
var errorsAreTheSame = (first, second) => {
  return first.stack === second.stack && first.message === second.message;
};
var BACKGROUND_COLOR = "#1f2428";
var Overlay = () => {
  const [errors, setErrors] = useState30({ type: "clear" });
  const addError = useCallback29((err) => {
    setErrors((state) => {
  ...
  useImperativeHandle10(setErrorsRef, () => {
  ...
  return /* @__PURE__ */ jsx65(KeybindingContextProvider, {
    children: /* @__PURE__ */ jsx65(AbsoluteFill2, {
      style: {
      ...
      children: errors.errors.map((err, i) => {
        return /* @__PURE__ */ jsx65(ErrorLoader, {
          keyboardShortcuts: i === 0,
          error: err,
          onRetry: null,
          canHaveDismissButton: true,
...
// src/error-overlay/react-overlay/effects/format-warning.ts
function stripInlineStacktrace(message) {
  return message.split(`
`).filter((line2) => !line2.match(/^\s*in/)).join(`
`);
}
function massageWarning(warning, frames) {
  ...
  for (let index = 0;index < frames.length; ++index) {
    ...
    if (fileName === null || lineNumber === null || lineNumber === undefined || fileName === undefined) {
      continue;
    }
...
// src/error-overlay/react-overlay/effects/stack-trace-limit.ts
...
// src/error-overlay/react-overlay/effects/unhandled-error.ts
...
// src/error-overlay/react-overlay/effects/unhandled-rejection.ts
...
function listenToRuntimeErrors(crash) {
  ...
  registerUnhandledError(window, (error) => {
  ...
  registerUnhandledRejection(window, (error) => {
    return crashWithFramesRunTime(error);
  });
  registerStackTraceLimit();
  registerReactStack();
  permanentRegister("error", (d) => {
...
import { useCallback as useCallback30, useEffect as useEffect24 } from "react";
...
var AskOnDiscord = ({ canHaveKeyboardShortcuts }) => {
  ...
  return /* @__PURE__ */ jsxs24(Button, {
    ...
    children: [
      "Ask on Discord",
      " ",
      canHaveKeyboardShortcuts ? /* @__PURE__ */ jsx67(ShortcutHint, {
        keyToPress: "d",
        cmdOrCtrl: true
      }) : null
    ]
...
import { useCallback as useCallback32, useMemo as useMemo41, useRef as useRef18, useState as useState31 } from "react";
...
var ErrorMessage = ({ message }) => {
  ...
  return /* @__PURE__ */ jsxs26("div", {
    ...
    children: [
      ...
      errorLines !== null && errorLines > maxLines ? /* @__PURE__ */ jsx71("div", {
        style: moreLine,
        children: /* @__PURE__ */ jsx71("button", {
          type: "button",
          onClick: toggle,
          style: moreButton,
          children: /* @__PURE__ */ jsx71(CaretDown2, {
            invert: expanded
          })
        })
      }) : null
  ...
  return /* @__PURE__ */ jsxs27("svg", {
    ...
    children: [
      /* @__PURE__ */ jsx72("path", {
        ...
        children: /* @__PURE__ */ jsx72("animate", {
...
import { jsx as jsx73, jsxs as jsxs28, Fragment as Fragment12 } from "react/jsx-runtime";
var title2 = {
  marginBottom: 8,
  display: "flex",
  flexDirection: "row",
...
var ErrorTitle = ({ name, message, symbolicating, canHaveDismissButton }) => {
  return /* @__PURE__ */ jsxs28("div", {
    ...
    children: [
          ...
          /* @__PURE__ */ jsxs28("div", {
            ...
            children: [
              symbolicating ? /* @__PURE__ */ jsxs28(Fragment12, {
                children: [
                  /* @__PURE__ */ jsx73(Symbolicating, {}),
                  /* @__PURE__ */ jsx73("div", {
                    style: spacer
                  })
                ]
              }) : null,
              /* @__PURE__ */ jsx73(ErrorMessage, {
                message
              })
            ]
          })
      ...
      didUnmountReactApp() ? null : canHaveDismissButton ? /* @__PURE__ */ jsx73(DismissButton, {}) : null
    ]
  });
};

// src/error-overlay/remotion-overlay/HelpLink.tsx
import { useCallback as useCallback33, useEffect as useEffect25 } from "react";
...
import { useCallback as useCallback35, useEffect as useEffect27 } from "react";
...
var SearchGithubIssues = ({ message, canHaveKeyboardShortcuts }) => {
  ...
  return /* @__PURE__ */ jsxs31(Button, {
    ...
    children: [
      ...
      " ",
      canHaveKeyboardShortcuts ? /* @__PURE__ */ jsx77(ShortcutHint, {
        keyToPress: "g",
        cmdOrCtrl: true
      }) : null
    ]
...
import { useCallback as useCallback36, useState as useState32 } from "react";
...
// src/error-overlay/remotion-overlay/StackFrame.tsx
import { jsx as jsx79, jsxs as jsxs33 } from "react/jsx-runtime";
var location = {
...
var StackElement = ({ s, lineNumberWidth, isFirst, defaultFunctionName }) => {
  const [showCodeFrame, setShowCodeFrame] = useState32(() => !s.originalFileName?.includes("node_modules") && !s.originalFileName?.startsWith("webpack/") || isFirst);
    ...
    children: [
      /* @__PURE__ */ jsxs33("div", {
        ...
        children: [
          ...
          s.originalScriptCode && s.originalScriptCode.length > 0 ? /* @__PURE__ */ jsx79(Button, {
            onClick: toggleCodeFrame,
            children: showCodeFrame ? /* @__PURE__ */ jsx79(CaretDown2, {
              invert: false
            }) : /* @__PURE__ */ jsx79(CaretRight2, {})
          }) : null
        ]
      }),
      /* @__PURE__ */ jsx79("div", {
        children: s.originalScriptCode && s.originalScriptCode.length > 0 && showCodeFrame ? /* @__PURE__ */ jsx79(CodeFrame, {
          lineNumberWidth,
...
// src/error-overlay/remotion-overlay/ErrorDisplay.tsx
import { jsx as jsx80, jsxs as jsxs34, Fragment as Fragment13 } from "react/jsx-runtime";
var stack = {
  marginTop: 17,
  overflowX: "scroll",
  marginBottom: "10vh"
...
`).replace(/\\t/g, "  ").replace(/^error:/, "").trim();
  ...
  return /* @__PURE__ */ jsxs34("div", {
    children: [
      ...
      /* @__PURE__ */ jsx80(SearchGithubIssues, {
        canHaveKeyboardShortcuts: keyboardShortcuts,
      ...
      calculateMetadata ? /* @__PURE__ */ jsxs34(Fragment13, {
        children: [
          /* @__PURE__ */ jsx80("br", {}),
          /* @__PURE__ */ jsx80(Spacing, {
            y: 0.5
          }),
          /* @__PURE__ */ jsx80(CalculateMetadataErrorExplainer, {})
        ]
      }) : null,
      /* @__PURE__ */ jsx80("div", {
        style: stack,
        ...
        children: display.stackFrames.map((s, i) => {
          return /* @__PURE__ */ jsx80(StackElement, {
            isFirst: i === 0,
            s,
            lineNumberWidth,
...
var ErrorLoader = ({
  ...
  if (state.type === "loading") {
    return /* @__PURE__ */ jsx81("div", {
      style: container18,
      children: /* @__PURE__ */ jsx81(ErrorTitle, {
        symbolicating: true,
        name: error.name,
        message: error.message,
        canHaveDismissButton
  ...
  return /* @__PURE__ */ jsx81("div", {
    style: container18,
    children: /* @__PURE__ */ jsx81(ErrorDisplay, {
      keyboardShortcuts,
...
import { memo, useCallback as useCallback37, useContext as useContext23, useMemo as useMemo45 } from "react";
...
var GuideComp = ({ guide, canvasDimensions, scale }) => {
  ...
  return /* @__PURE__ */ jsx82(ContextMenu, {
    values,
...
// src/components/EditorGuides/index.tsx
import { jsx as jsx83, Fragment as Fragment14 } from "react/jsx-runtime";
var EditorGuides = ({ canvasSize, contentDimensions, assetMetadata }) => {
  ...
  return /* @__PURE__ */ jsx83(Fragment14, {
    children: guidesForThisComposition.map((guide) => {
      return /* @__PURE__ */ jsx83(Guide_default, {
        guide,
        canvasDimensions,
        scale
      }, guide.id);
...
var Ruler = ({
  ...
  const [cursor, setCursor] = useState34(isVerticalRuler ? "ew-resize" : "ns-resize");
...
// src/components/EditorRuler/index.tsx
import { jsx as jsx85, jsxs as jsxs36, Fragment as Fragment15 } from "react/jsx-runtime";
...
// src/components/Canvas.tsx
import { jsx as jsx87, jsxs as jsxs37, Fragment as Fragment16 } from "react/jsx-runtime";
var container19 = {
  flex: 1,
  display: "flex",
  overflow: "hidden",
...
var Canvas = ({ canvasContent, size: size2 }) => {
  ...
  const [assetResolution, setAssetResolution] = useState35(null);
  ...
  return /* @__PURE__ */ jsxs37(Fragment16, {
    children: [
      /* @__PURE__ */ jsxs37("div", {
        ...
        style: container19,
        children: [
          size2 ? /* @__PURE__ */ jsx87(VideoPreview, {
            canvasContent,
            contentDimensions,
            canvasSize: size2,
            assetMetadata: assetResolution
          }) : null,
          isFit ? null : /* @__PURE__ */ jsx87("div", {
            style: resetZoom,
            className: "css-reset",
            children: /* @__PURE__ */ jsx87(ResetZoomButton, {
              onClick: onReset
            })
          }),
          editorShowGuides && canvasContent.type === "composition" && /* @__PURE__ */ jsx87(EditorGuides_default, {
            canvasSize: size2,
            contentDimensions,
            assetMetadata: assetResolution
          })
      ...
      areRulersVisible && /* @__PURE__ */ jsx87(EditorRulers, {
        contentDimensions,
        canvasSize: size2,
        assetMetadata: assetResolution,
...
var RunningCalculateMetadata = () => {
  return /* @__PURE__ */ jsxs38("div", {
    style: container20,
    children: [
      /* @__PURE__ */ jsx88(Spinner, {
        size: 24,
        duration: 1
      }),
      /* @__PURE__ */ jsx88(Spacing, {
        x: 2
      }),
      /* @__PURE__ */ jsxs38("div", {
        style: loaderLabel,
...
var RefreshCompositionOverlay = () => {
  return /* @__PURE__ */ jsx89(AbsoluteFill3, {
    style: container21,
    children: /* @__PURE__ */ jsx89("div", {
      style: shadow,
...
// src/components/CanvasOrLoading.tsx
import { jsx as jsx90, jsxs as jsxs39, Fragment as Fragment17 } from "react/jsx-runtime";
var container22 = {
  color: "white",
  flex: 1,
  justifyContent: "center",
...
var CanvasOrLoading = ({ size: size2 }) => {
  ...
  const content = /* @__PURE__ */ jsxs39(Fragment17, {
    children: [
      /* @__PURE__ */ jsx90(ZoomPersistor, {}),
      /* @__PURE__ */ jsx90(Canvas, {
        size: size2,
        canvasContent
      }),
      resolved?.type === "success-and-refreshing" ? /* @__PURE__ */ jsx90(RefreshCompositionOverlay, {}) : null
    ]
  });
  ...
  if (resolved.type === "error") {
    return /* @__PURE__ */ jsx90(ErrorLoading, {
      error: resolved.error
    });
  }
  return /* @__PURE__ */ jsxs39(Fragment17, {
    children: [
      /* @__PURE__ */ jsx90(FramePersistor, {}),
      " ",
      content
    ]
  });
...
var ErrorLoading = ({ error }) => {
  return /* @__PURE__ */ jsx90("div", {
    ...
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: /* @__PURE__ */ jsx90(ErrorLoader, {
...
var CanvasIfSizeIsAvailable = () => {
  ...
  return /* @__PURE__ */ jsx91(CanvasOrLoading, {
    size: sizeWithRulersApplied
  });
};

// src/components/CurrentCompositionSideEffects.tsx
import { useCallback as useCallback41, useContext as useContext31, useEffect as useEffect34 } from "react";
...
function MobilePanel({
  ...
  return ReactDOM6.createPortal(/* @__PURE__ */ jsxs40("div", {
    ...
    children: [
      /* @__PURE__ */ jsx92("div", {
        style: buttonContainer,
        children: /* @__PURE__ */ jsx92(CancelButton, {
          style: button2,
          onPress: onClose
        })
      }),
...
var visualControlRef = createRef9();
...
var VisualControlsProvider = ({ children }) => {
  ...
  const [handles, setHandles] = useState37({});
  ...
  useImperativeHandle11(visualControlRef, () => {
    return {
  ...
  return /* @__PURE__ */ jsx94(VisualControlsTabActivatedContext.Provider, {
    value: Object.keys(state.handles).length > 0,
    children: /* @__PURE__ */ jsx94(VisualControlsContext.Provider, {
      value: state,
      children: /* @__PURE__ */ jsx94(SetVisualControlsContext.Provider, {
        value: setState,
        children
      })
    })
...
import React62, { useCallback as useCallback45, useContext as useContext33 } from "react";
...
var GlobalPropsEditorUpdateButton = ({ compositionId, currentDefaultProps }) => {
  ...
  const [disabled, setDisabled] = React62.useState(false);
  ...
  return /* @__PURE__ */ jsxs41("div", {
    style: container24,
    children: [
      /* @__PURE__ */ jsx97(SchemaResetButton, {
        onClick: onReset
      }),
      /* @__PURE__ */ jsx97(SchemaSaveButton, {
        disabled,
        onClick: onClicked
      })
    ]
...
var ValidationMessage = ({ message, align, type }) => {
  ...
  return /* @__PURE__ */ jsx98("div", {
    ...
    children: /* @__PURE__ */ jsxs42(Row, {
      ...
      justify: align,
      children: [
        /* @__PURE__ */ jsx98(WarningTriangle, {
          style: finalStyle
        }),
...
import { useCallback as useCallback46, useMemo as useMemo54, useState as useState38 } from "react";
...
import React66, { useCallback as useCallback47, useEffect as useEffect37, useMemo as useMemo56 } from "react";
    ...
    return /* @__PURE__ */ jsx100("div", {
      children: zodValidationResult.error.errors.map((error) => {
        return /* @__PURE__ */ jsxs43("div", {
          style: style7,
          children: [
            /* @__PURE__ */ jsx100(WarningTriangle, {
              style: triangleStyle
            }),
...
var RenderModalJSONPropsEditor = ({
  ...
  const keybindings = useKeybinding();
  const [localValue, setLocalValue] = React66.useState(() => {
  ...
  return /* @__PURE__ */ jsxs44("div", {
    ...
    children: [
      ...
      localValue.validJSON === false ? /* @__PURE__ */ jsx101(ValidationMessage, {
        align: "flex-start",
        message: localValue.error,
        type: "error"
      }) : localValue.zodValidation.success === false ? /* @__PURE__ */ jsx101(ZodErrorMessages, {
      ...
      /* @__PURE__ */ jsxs44(Row, {
        children: [
          ...
          showSaveButton ? /* @__PURE__ */ jsx101(Button, {
            onClick: onSave,
...
import { useCallback as useCallback67, useEffect as useEffect42, useMemo as useMemo77, useState as useState49 } from "react";
...
var InvalidDefaultProps = ({ zodValidationResult }) => {
  return /* @__PURE__ */ jsxs45("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx102(ZodErrorMessages, {
        zodValidationResult,
        viewTab: "schema"
      }),
      /* @__PURE__ */ jsx102(Spacing, {
...
var Fieldset = ({ children, shouldPad }) => {
  ...
  const content = /* @__PURE__ */ jsx103("div", {
    style: style8,
    children
  });
  if (shouldPad) {
    return /* @__PURE__ */ jsx103(AlreadyPaddedRightContext.Provider, {
      value: true,
      children: content
    });
  }
...
import { useCallback as useCallback49, useMemo as useMemo58, useState as useState39 } from "react";
...
var InlineRemoveButton = ({ onClick }) => {
  ...
  return /* @__PURE__ */ jsx104(InlineAction, {
    renderAction,
    onClick
  });
};
...
var defaultPropsEditorScrollableAreaRef = React68.createRef();
...
var SchemaLabel = ({
  ...
  const [clickableButtonHovered, setClickableButtonHovered] = useState39(false);
  ...
  return /* @__PURE__ */ jsxs46("div", {
    ...
    children: [
      handleClick ? /* @__PURE__ */ jsx105("button", {
      ...
      /* @__PURE__ */ jsx105(Flex, {}),
      isDefaultValue ? null : /* @__PURE__ */ jsx105(SchemaResetButton, {
        onClick: onReset
      }),
      isDefaultValue ? null : showSaveButton ? /* @__PURE__ */ jsx105(SchemaSaveButton, {
        onClick: onSave,
        disabled: disableSave
      }) : null,
      onRemove ? /* @__PURE__ */ jsx105(InlineRemoveButton, {
        onClick: onRemove
      }) : null
    ]
  });
...
import { useCallback as useCallback50, useMemo as useMemo59, useState as useState40 } from "react";
...
// src/components/RenderModal/SchemaEditor/SchemaSeparationLine.tsx
import { jsx as jsx107, jsxs as jsxs47, Fragment as Fragment18 } from "react/jsx-runtime";
...
var SchemaArrayItemSeparationLine = ({ onChange, index, schema, isLast, showAddButton }) => {
  const [outerHovered, setOuterHovered] = useState40(false);
  const [innerHovered, setInnerHovered] = useState40(false);
  ...
  return /* @__PURE__ */ jsxs47("div", {
    ...
    children: [
      /* @__PURE__ */ jsxs47("div", {
        ...
        children: [
          showAddButton && /* @__PURE__ */ jsx107("div", {
...
import React75, { useMemo as useMemo65, useState as useState43 } from "react";

// src/components/RenderModal/SchemaEditor/ZodArrayItemEditor.tsx
import { useCallback as useCallback51, useMemo as useMemo61 } from "react";
...
var ZodArrayItemEditor = ({
  ...
  return /* @__PURE__ */ jsx109("div", {
    children: /* @__PURE__ */ jsx109(ZodSwitch, {
...
import { useCallback as useCallback52, useEffect as useEffect38, useMemo as useMemo63, useRef as useRef23, useState as useState41 } from "react";
import ReactDOM7 from "react-dom";

// src/components/RenderModal/InfoTooltip.tsx
import { useMemo as useMemo62 } from "react";
import { jsx as jsx110, jsxs as jsxs49 } from "react/jsx-runtime";
var arrow = {
  height: 7,
  display: "block",
  overflow: "visible",
...
var InfoTooltip = ({ children, arrowDirection, backgroundColor }) => {
  ...
  return /* @__PURE__ */ jsxs49("div", {
    ...
    children: [
      ...
      arrowDirection === "down" ? /* @__PURE__ */ jsx110("svg", {
        viewBox: "0 0 14 7",
        style: arrowDown,
      ...
      arrowDirection === "up" ? /* @__PURE__ */ jsx110("svg", {
        viewBox: "0 0 14 7",
        style: arrowUp,
        children: /* @__PURE__ */ jsx110("path", {
...
// src/components/RenderModal/InfoBubble.tsx
import { jsx as jsx111, jsxs as jsxs50, Fragment as Fragment19 } from "react/jsx-runtime";
var icon4 = {
  color: LIGHT_TEXT,
  height: 15
};
...
var InfoBubble = ({ title: title3, children }) => {
  const [hovered, setIsHovered] = useState41(false);
  const [opened, setOpened] = useState41(false);
  ...
  return /* @__PURE__ */ jsxs50(Fragment19, {
    children: [
      ...
      portalStyle ? ReactDOM7.createPortal(/* @__PURE__ */ jsx111("div", {
        style: outerPortal,
        className: "css-reset",
        children: /* @__PURE__ */ jsx111(HigherZIndex, {
          onOutsideClick: onHide,
          onEscape: onHide,
          children: /* @__PURE__ */ jsx111("div", {
            style: portalStyle,
            children: /* @__PURE__ */ jsx111(InfoTooltip, {
              backgroundColor: INPUT_BACKGROUND,
...
var ZodFieldValidation = ({ localValue, path }) => {
  ...
  return /* @__PURE__ */ jsxs51("div", {
    style: legend,
    children: [
      /* @__PURE__ */ jsx112(ValidationMessage, {
        align: "flex-start",
        message: localValue.zodValidation.error.format()._errors[0],
        type: "error"
      }),
      /* @__PURE__ */ jsx112(Spacing, {
        x: 0.5
      }),
      /* @__PURE__ */ jsx112(InfoBubble, {
...
var useLocalState = ({
  ...
  const [resetRevision, setResetRevision] = useState42(0);
  const [localValueOrNull, setLocalValue] = useState42(() => {
    return {
      [parentRevision]: {
        value: unsavedValue,
  ...
  const RevisionContextProvider = useCallback53(({ children }) => {
    return /* @__PURE__ */ jsx113(RevisionContext.Provider, {
      value: contextValue,
      children
    });
  }, [contextValue]);
  ...
  return /* @__PURE__ */ jsxs52(Fieldset, {
    ...
    children: [
      /* @__PURE__ */ jsx114("div", {
        ...
        children: /* @__PURE__ */ jsx114(SchemaLabel, {
          onReset: reset,
          isDefaultValue,
          jsonPath,
          onRemove,
      ...
      expanded ? /* @__PURE__ */ jsx114(RevisionContextProvider, {
        children: /* @__PURE__ */ jsxs52(SchemaVerticalGuide, {
          isRoot: false,
          children: [
            localValue.value.map((child, i) => {
              return /* @__PURE__ */ jsxs52(React75.Fragment, {
                children: [
                  /* @__PURE__ */ jsx114(ZodArrayItemEditor, {
                    onChange,
                    value: child,
                    def,
                    index: i,
                  ...
                  /* @__PURE__ */ jsx114(SchemaArrayItemSeparationLine, {
                    schema,
                    index: i,
                    onChange,
            ...
            value.length === 0 ? /* @__PURE__ */ jsx114(SchemaArrayItemSeparationLine, {
              schema,
              index: 0,
              onChange,
              isLast: true,
...
var Checkbox = ({ checked, onChange, disabled, name }) => {
  ...
  return /* @__PURE__ */ jsxs53("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx115("div", {
        style: box,
        children: checked ? /* @__PURE__ */ jsx115(Checkmark, {}) : null
      })
    ]
  });
};
...
var ZodBooleanEditor = ({
  ...
  return /* @__PURE__ */ jsxs54(Fieldset, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx116("div", {
        style: fullWidth,
        children: /* @__PURE__ */ jsx116(Checkbox, {
          name: jsonPath.join("."),
...
import { useCallback as useCallback56, useMemo as useMemo69 } from "react";
...
import React78, { useCallback as useCallback55, useEffect as useEffect40, useMemo as useMemo67, useRef as useRef25, useState as useState44 } from "react";
...
var InputDraggerForwardRefFn = ({
  ...
  if (inputFallback) {
    return /* @__PURE__ */ jsx117(HigherZIndex, {
      onEscape,
      onOutsideClick: noop,
      children: /* @__PURE__ */ jsx117(RemotionInput, {
        ref: fallbackRef,
        autoFocus: true,
        onKeyPress,
        onBlur,
...
var InputDragger = React78.forwardRef(InputDraggerForwardRefFn);
        ...
        children: [
          /* @__PURE__ */ jsxs55(Row, {
            ...
            children: [
              /* @__PURE__ */ jsx119("div", {
                style: colorPicker,
                children: /* @__PURE__ */ jsx119(RemInputTypeColor, {
                  type: "color",
                  style: {
                    height: 39
                  },
...
var ZodDefaultEditor = ({
  ...
  return /* @__PURE__ */ jsx121(ZodSwitch, {
    defaultValue,
    jsonPath,
    onRemove,
    onSave,
...
var ZodDiscriminatedUnionEditor = ({
  ...
  const comboBoxValues = useMemo70(() => {
    return options.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: option === value[typedSchema.discriminator] ? /* @__PURE__ */ jsx122(Checkmark, {}) : null,
        onClick: () => {
  ...
  return /* @__PURE__ */ jsx122(ZodObjectEditor, {
    jsonPath,
    mayPad,
    savedValue: defaultValue,
    onRemove,
...
import { jsx as jsx123, jsxs as jsxs58 } from "react/jsx-runtime";
var fullWidth4 = {
  width: "100%"
};
var ZodEffectEditor = ({
  ...
  return /* @__PURE__ */ jsxs58(Fieldset, {
    ...
    children: [
      /* @__PURE__ */ jsx123("div", {
        style: fullWidth4,
        children: /* @__PURE__ */ jsx123(ZodSwitch, {
          value,
          setValue: onChange,
          jsonPath,
          schema: def.schema,
...
import { useCallback as useCallback59, useMemo as useMemo71 } from "react";
import { jsx as jsx124, jsxs as jsxs59 } from "react/jsx-runtime";
var container28 = {
  width: "100%"
};
var ZodEnumEditor = ({
  ...
  const comboBoxValues = useMemo71(() => {
    return def.values.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: option === value ? /* @__PURE__ */ jsx124(Checkmark, {}) : null,
        onClick: (id) => {
...
import React83, { useMemo as useMemo72, useState as useState46 } from "react";
import { jsx as jsx125, jsxs as jsxs60 } from "react/jsx-runtime";
var rowStyle = {
  display: "flex",
  flexDirection: "row",
  width: "100%"
      ...
      expanded ? /* @__PURE__ */ jsx125(RevisionContextProvider, {
        children: /* @__PURE__ */ jsxs60(SchemaVerticalGuide, {
          ...
          children: [
            ...
            value.length === 0 ? /* @__PURE__ */ jsx125(SchemaArrayItemSeparationLine, {
              schema,
              index: 0,
              onChange,
              isLast: true,
...
import { jsx as jsx126, jsxs as jsxs61 } from "react/jsx-runtime";
var fullWidth5 = {
  width: "100%"
};
var emptyLabel = {
...
var ZodOrNullishEditor = ({
  ...
  return /* @__PURE__ */ jsxs62(Fieldset, {
    ...
    success: localValue.zodValidation.success,
    children: [
      localValue.value === nullishValue ? /* @__PURE__ */ jsx127(SchemaLabel, {
        handleClick: null,
        isDefaultValue: localValue.value === defaultValue,
        jsonPath,
        onReset: reset,
      ...
      /* @__PURE__ */ jsxs62("div", {
        ...
        children: [
          /* @__PURE__ */ jsx127(Checkbox, {
            checked: isChecked,
            onChange: onCheckBoxChange,
            disabled: false,
            name: jsonPath.join(".")
          }),
          /* @__PURE__ */ jsx127(Spacing, {
            x: 1
          }),
          /* @__PURE__ */ jsx127("div", {
            style: labelStyle4,
...
var ZodNullableEditor = ({
  ...
  const { innerType } = schema._def;
  return /* @__PURE__ */ jsx128(ZodOrNullishEditor, {
    defaultValue,
    jsonPath,
    onRemove,
    onSave,
...
import { jsx as jsx129, jsxs as jsxs63 } from "react/jsx-runtime";
var fullWidth6 = {
  width: "100%"
};
...
import { useCallback as useCallback63, useMemo as useMemo73 } from "react";
import { jsx as jsx131, jsxs as jsxs64 } from "react/jsx-runtime";
var container29 = {
  width: "100%"
};
  ...
  const comboBoxValues = useMemo73(() => {
    return getStaticFiles().map((option) => {
      return {
        ...
        id: option.src,
        keyHint: null,
        leftItem: option.src === value ? /* @__PURE__ */ jsx131(Checkmark, {}) : null,
        onClick: (id) => {
          setLocalValue(() => id, false, false);
        },
        quickSwitcherLabel: null,
  ...
  return /* @__PURE__ */ jsxs64(Fieldset, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx131("div", {
        ...
        children: /* @__PURE__ */ jsx131(Combobox, {
          values: comboBoxValues,
...
import React89, { useMemo as useMemo75, useState as useState47 } from "react";

// src/components/RenderModal/SchemaEditor/ZodTupleItemEditor.tsx
import { useCallback as useCallback66, useMemo as useMemo74 } from "react";
...
var ZodTupleItemEditor = ({
  ...
  return /* @__PURE__ */ jsx134("div", {
    children: /* @__PURE__ */ jsx134(ZodSwitch, {
      jsonPath: newJsonPath,
...
// src/components/RenderModal/SchemaEditor/ZodTupleEditor.tsx
import { jsx as jsx135, jsxs as jsxs67 } from "react/jsx-runtime";
var ZodTupleEditor = ({
  schema,
  jsonPath,
  setValue,
  ...
  return /* @__PURE__ */ jsxs67(Fieldset, {
    ...
    children: [
      /* @__PURE__ */ jsx135("div", {
        ...
        children: /* @__PURE__ */ jsx135(SchemaLabel, {
          onReset: reset,
          isDefaultValue,
          jsonPath,
          onRemove,
      ...
      expanded ? /* @__PURE__ */ jsx135(RevisionContextProvider, {
        children: /* @__PURE__ */ jsxs67(SchemaVerticalGuide, {
          isRoot: false,
          children: [
            localValue.value.map((child, i) => {
              return /* @__PURE__ */ jsxs67(React89.Fragment, {
                children: [
                  /* @__PURE__ */ jsx135(ZodTupleItemEditor, {
                    onChange,
                    value: child,
                    def,
                    index: i,
                  ...
                  /* @__PURE__ */ jsx135(SchemaArrayItemSeparationLine, {
                    schema,
                    index: i,
                    onChange,
                    isLast: i === localValue.value.length - 1,
            ...
            value.length === 0 ? /* @__PURE__ */ jsx135(SchemaArrayItemSeparationLine, {
              schema,
              index: 0,
              onChange,
              isLast: true,
      ...
      /* @__PURE__ */ jsx135(ZodFieldValidation, {
        path: jsonPath,
        localValue
      })
    ]
...
var ZodUnionEditor = ({
  ...
  return /* @__PURE__ */ jsx136(ZodOrNullishEditor, {
    defaultValue,
    jsonPath,
    onRemove,
    onSave,
...
var ZodSwitch = ({
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodObject) {
    return /* @__PURE__ */ jsx137(ZodObjectEditor, {
      setValue,
      unsavedValue: value,
      savedValue: defaultValue,
      jsonPath,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodString) {
    if (value.startsWith(window.remotion_staticBase)) {
      return /* @__PURE__ */ jsx137(ZodStaticFileEditor, {
        setValue,
        value,
        jsonPath,
        schema,
    ...
    if (zodTypes && schema._def.description === zodTypes.ZodZypesInternals.REMOTION_TEXTAREA_BRAND) {
      return /* @__PURE__ */ jsx137(ZodTextareaEditor, {
        value,
        setValue,
        jsonPath,
        schema,
    ...
    return /* @__PURE__ */ jsx137(ZodStringEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDate) {
    return /* @__PURE__ */ jsx137(ZodDateEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodNumber) {
    return /* @__PURE__ */ jsx137(ZodNumberEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodBoolean) {
    return /* @__PURE__ */ jsx137(ZodBooleanEditor, {
      value,
      setValue,
      jsonPath,
      defaultValue,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodArray) {
    return /* @__PURE__ */ jsx137(ZodArrayEditor, {
      setValue,
      value,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodEnum) {
    return /* @__PURE__ */ jsx137(ZodEnumEditor, {
      setValue,
      value,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodEffects) {
    if (zodTypes && schema._def.description === zodTypes.ZodZypesInternals.REMOTION_COLOR_BRAND) {
      return /* @__PURE__ */ jsx137(ZodColorEditor, {
        value,
        setValue,
        jsonPath,
        schema,
    ...
    if (zodTypes && schema._def.description === zodTypes.ZodZypesInternals.REMOTION_MATRIX_BRAND) {
      return /* @__PURE__ */ jsx137(ZodMatrixEditor, {
        setValue,
        value,
        jsonPath,
    ...
    return /* @__PURE__ */ jsx137(ZodEffectEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodUnion) {
    return /* @__PURE__ */ jsx137(ZodUnionEditor, {
      schema,
      showSaveButton,
      jsonPath,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodOptional) {
    return /* @__PURE__ */ jsx137(ZodOptionalEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodNullable) {
    return /* @__PURE__ */ jsx137(ZodNullableEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDefault) {
    return /* @__PURE__ */ jsx137(ZodDefaultEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDiscriminatedUnion) {
    return /* @__PURE__ */ jsx137(ZodDiscriminatedUnionEditor, {
      defaultValue,
      mayPad,
      schema,
      setValue,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodTuple) {
    return /* @__PURE__ */ jsx137(ZodTupleEditor, {
      setValue,
      value,
      jsonPath,
      schema,
...
var ZodObjectEditor = ({
  ...
  return /* @__PURE__ */ jsxs68(Fieldset, {
    ...
    success: localValue.zodValidation.success,
    children: [
      isRoot ? null : /* @__PURE__ */ jsx138(SchemaLabel, {
        isDefaultValue,
        onReset: reset,
        jsonPath,
        onRemove,
      ...
      expanded ? /* @__PURE__ */ jsx138(RevisionContextProvider, {
        children: /* @__PURE__ */ jsx138(SchemaVerticalGuide, {
          isRoot,
          children: keys.map((key, i) => {
            ...
            return /* @__PURE__ */ jsxs68(React90.Fragment, {
              children: [
                /* @__PURE__ */ jsx138(ZodSwitch, {
                  mayPad: true,
                ...
                i === keys.length - 1 ? null : /* @__PURE__ */ jsx138(SchemaSeparationLine, {})
              ]
            }, key);
          })
        })
      }) : null,
      isRoot || !expanded ? null : /* @__PURE__ */ jsx138("div", {
        style: fieldsetLabel,
        children: "}"
      })
    ]
...
var SchemaEditor = ({
  ...
  const keybindings = useKeybinding();
  const [revision, setRevision] = useState49(0);
  ...
  if (!zodValidationResult.success) {
    ...
    if (!defaultPropsValid.success) {
      return /* @__PURE__ */ jsx139(InvalidDefaultProps, {
        zodValidationResult
      });
    }
    return /* @__PURE__ */ jsx139(InvalidSchema, {
      reset,
      zodValidationResult
    });
  }
  if (typeName !== z.ZodFirstPartyTypeKind.ZodObject) {
    return /* @__PURE__ */ jsx139(TopLevelZodValue, {
  ...
  return /* @__PURE__ */ jsx139("div", {
    ...
    style: scrollable2,
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: /* @__PURE__ */ jsx139(RevisionContext.Provider, {
      value: revisionState,
      children: /* @__PURE__ */ jsx139(ZodObjectEditor, {
        discriminatedUnionReplacement: null,
...
import { useCallback as useCallback68, useMemo as useMemo78 } from "react";
import { jsx as jsx140, jsxs as jsxs69 } from "react/jsx-runtime";
var style8 = {
  fontSize: 12,
  display: "inline-flex",
  justifyContent: "center",
...
var WarningIndicatorButton = ({ setShowWarning, showWarning, warningCount }) => {
  ...
  return /* @__PURE__ */ jsxs69("button", {
    ...
    onClick,
    children: [
      /* @__PURE__ */ jsx140(WarningTriangle2, {
...
var DataEditor = ({
  ...
  const [mode, setMode] = useState50("schema");
  const [showWarning, setShowWarningWithoutPersistance] = useState50(() => getPersistedShowWarningState());
  ...
  const [canSaveDefaultPropsObjectState, setCanSaveDefaultProps] = useState50({
  ...
  if (schema === "no-zod") {
    return /* @__PURE__ */ jsx141(ZodNotInstalled, {});
  }
  if (schema === "no-schema") {
    return /* @__PURE__ */ jsx141(NoSchemaDefined, {});
  }
  if (!z) {
    throw new Error("expected zod");
  }
  ...
  if (!unresolvedComposition.defaultProps) {
    return /* @__PURE__ */ jsx141(NoDefaultProps, {});
  }
  return /* @__PURE__ */ jsxs70("div", {
    style: outer,
    children: [
      /* @__PURE__ */ jsxs70("div", {
        ...
        children: [
          /* @__PURE__ */ jsxs70("div", {
            style: tabWrapper,
            children: [
              /* @__PURE__ */ jsx141(SegmentedControl, {
                items: modeItems,
                needsWrapping: false
              }),
              /* @__PURE__ */ jsx141(Flex, {}),
              warnings.length > 0 ? /* @__PURE__ */ jsx141(WarningIndicatorButton, {
                setShowWarning,
                showWarning,
          ...
          showWarning && warnings.length > 0 ? warnings.map((warning) => /* @__PURE__ */ jsxs70(React93.Fragment, {
            children: [
              /* @__PURE__ */ jsx141(Spacing, {
                y: 1
              }),
              /* @__PURE__ */ jsx141(ValidationMessage, {
                message: warning,
                align: "flex-start",
                type: "warning"
              })
      ...
      mode === "schema" ? /* @__PURE__ */ jsx141(SchemaEditor, {
      ...
      }) : /* @__PURE__ */ jsx141(RenderModalJSONPropsEditor, {
        value: defaultProps ?? {},
        setValue: setDefaultProps,
        onSave: onUpdate,
        showSaveButton,
...
import React103, { useContext as useContext42, useEffect as useEffect45, useMemo as useMemo86 } from "react";
...
var RenderQueueCopyToClipboard = ({ job }) => {
  const renderCopyAction = useCallback70((color) => {
    return /* @__PURE__ */ jsx142(ClipboardIcon, {
  ...
  return /* @__PURE__ */ jsx142(InlineAction, {
...
import React96, { useCallback as useCallback73, useContext as useContext38 } from "react";
...
var CircularProgress = ({ progress }) => {
  ...
  return /* @__PURE__ */ jsx145("svg", {
    ...
    children: /* @__PURE__ */ jsx145("circle", {
...
var RenderQueueItemStatus = ({ job }) => {
  ...
  const [hovered, setHovered] = React96.useState(false);
  ...
  if (job.status === "running") {
    return /* @__PURE__ */ jsx146("button", {
      ...
      style: invisibleStyle,
      onClick,
      children: /* @__PURE__ */ jsx146(CircularProgress, {
...
import { useCallback as useCallback74, useMemo as useMemo81 } from "react";
...
var RenderQueueOpenInFinderItem = ({ job }) => {
  ...
  const renderAction = useCallback74((color) => {
    return /* @__PURE__ */ jsx147(ExpandedFolderIconSolid, {
      style: icon5,
      color
    });
  }, [icon5]);
  return /* @__PURE__ */ jsx147(InlineAction, {
    renderAction,
    onClick
  });
};
...
import { useCallback as useCallback75, useContext as useContext39 } from "react";
...
import { useCallback as useCallback76, useMemo as useMemo83 } from "react";
...
import { useCallback as useCallback77, useContext as useContext40, useMemo as useMemo84 } from "react";
...
var RenderQueueRepeatItem = ({ job }) => {
  ...
  return /* @__PURE__ */ jsx151(InlineAction, {
    onClick,
    renderAction
  });
};
...
var RenderQueueItem = ({ job, selected }) => {
  ...
  return /* @__PURE__ */ jsxs71(Row, {
    ...
    children: [
      /* @__PURE__ */ jsx152(RenderQueueItemStatus, {
        job
      }),
      ...
      /* @__PURE__ */ jsxs71("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx152("div", {
            style: subtitle2,
            children: job.status === "done" ? /* @__PURE__ */ jsx152(RenderQueueOutputName, {
              job
            }) : job.status === "failed" ? /* @__PURE__ */ jsx152(RenderQueueError, {
              job
            }) : job.status === "running" ? /* @__PURE__ */ jsx152(RenderQueueProgressMessage, {
              job
            }) : null
          })
        ]
      ...
      supportsCopyingToClipboard(job) ? /* @__PURE__ */ jsx152(RenderQueueCopyToClipboard, {
        job
      }) : null,
      job.status === "done" || job.status === "failed" ? /* @__PURE__ */ jsx152(RenderQueueRepeatItem, {
        job
      }) : null,
      job.status === "running" ? /* @__PURE__ */ jsx152(RenderQueueCancelButton, {
        job
      }) : /* @__PURE__ */ jsx152(RenderQueueRemoveItem, {
        job
      }),
      job.status === "done" ? /* @__PURE__ */ jsx152(RenderQueueOpenInFinderItem, {
        job
      }) : null
    ]
  });
...
// src/components/RenderQueue/index.tsx
import { jsx as jsx153, jsxs as jsxs72 } from "react/jsx-runtime";
var separatorStyle = {
  borderBottom: `1px solid ${BORDER_COLOR}`
};
...
var RenderQueue = () => {
  ...
  const previousJobCount = React103.useRef(jobs.length);
  const jobCount = jobs.length;
  const divRef = React103.useRef(null);
  useEffect45(() => {
    if (!divRef.current) {
      return;
    }
  ...
  return /* @__PURE__ */ jsx153("div", {
    ...
    children: jobs.map((j, index) => {
      return /* @__PURE__ */ jsx153("div", {
        ...
        children: /* @__PURE__ */ jsx153(RenderQueueItem, {
...
import { jsx as jsx154, jsxs as jsxs73, Fragment as Fragment20 } from "react/jsx-runtime";
var row3 = {
  display: "flex",
  flexDirection: "row",
  fontSize: 14,
...
import React106, { useContext as useContext45 } from "react";

// src/components/VisualControls/VisualControlHandle.tsx
import { useCallback as useCallback80, useContext as useContext44, useEffect as useEffect47, useState as useState54 } from "react";
...
import { useCallback as useCallback79, useMemo as useMemo88, useState as useState52 } from "react";
...
var ClickableFileName = ({
  ...
  const [titleHovered, setTitleHovered] = useState52(false);
...
var VisualControlHandleHeader = ({ originalFileName }) => {
  return /* @__PURE__ */ jsx156(ClickableFileName, {
    originalFileName
  });
};
...
// src/components/VisualControls/VisualControlHandle.tsx
import { jsx as jsx157, jsxs as jsxs74, Fragment as Fragment21 } from "react/jsx-runtime";
var VisualControlHandle = ({ value, keyName }) => {
  ...
  return /* @__PURE__ */ jsxs74(Fragment21, {
    children: [
      /* @__PURE__ */ jsx157(VisualControlHandleHeader, {
        originalFileName
      }),
      /* @__PURE__ */ jsx157(Spacing, {
        block: true,
        y: 0.5
      }),
      /* @__PURE__ */ jsx157(RevisionContextProvider, {
        children: /* @__PURE__ */ jsx157(ZodSwitch, {
          mayPad: true,
          schema: value.schema,
...
var VisualControlsContent = () => {
  ...
  return /* @__PURE__ */ jsx158("div", {
    ...
    children: entries.map(([key, value], i) => {
      return /* @__PURE__ */ jsxs75(React106.Fragment, {
        children: [
          /* @__PURE__ */ jsx158(VisualControlHandle, {
            keyName: key,
            value
          }),
          i === entries.length - 1 ? null : /* @__PURE__ */ jsx158(SchemaSeparationLine, {})
        ]
      }, key);
    })
  });
...
// src/components/OptionsPanel.tsx
import { jsx as jsx159, jsxs as jsxs76 } from "react/jsx-runtime";
...
var OptionsPanel = ({ readOnlyStudio }) => {
  ...
  const [panel2, setPanel] = useState55(() => getSelectedPanel2(readOnlyStudio));
  ...
  useImperativeHandle13(optionsSidebarTabs, () => {
    return {
      selectRendersPanel: () => {
        setPanel("renders");
        persistSelectedOptionsSidebarPanel2("renders");
    ...
    children: [
      /* @__PURE__ */ jsx159("div", {
        ...
        children: /* @__PURE__ */ jsxs76(Tabs, {
          children: [
            visualControlsTabActivated ? /* @__PURE__ */ jsx159(Tab, {
            ...
            composition ? /* @__PURE__ */ jsxs76(Tab, {
              ...
              children: [
                "Props",
                unsavedChangesExist ? /* @__PURE__ */ jsx159(GlobalPropsEditorUpdateButton, {
                  compositionId: composition.id,
                  currentDefaultProps
                }) : null
              ]
            }) : null,
            readOnlyStudio ? null : /* @__PURE__ */ jsx159(RendersTab, {
      ...
      panel2 === `input-props` && composition ? /* @__PURE__ */ jsx159(DataEditor, {
        ...
        setSaving,
        readOnlyStudio
      }, composition.id) : panel2 === "visual-controls" && visualControlsTabActivated ? /* @__PURE__ */ jsx159(VisualControlsContent, {}) : readOnlyStudio ? null : /* @__PURE__ */ jsx159(RenderQueue, {})
    ]
  });
};

// src/components/PreviewToolbar.tsx
import { useContext as useContext53, useEffect as useEffect54, useRef as useRef28, useState as useState58 } from "react";
...
import { useCallback as useCallback82, useContext as useContext47 } from "react";
...
import { useCallback as useCallback83, useContext as useContext48, useEffect as useEffect50 } from "react";
...
var MuteToggle = ({ muted, setMuted }) => {
  ...
  return /* @__PURE__ */ jsx164(ControlButton, {
    ...
    onClick,
    children: muted ? /* @__PURE__ */ jsx164(VolumeOffIcon, {}) : /* @__PURE__ */ jsx164(VolumeOnIcon, {})
  });
};

// src/components/PlayPause.tsx
import { PlayerInternals as PlayerInternals12 } from "@remotion/player";
import { useCallback as useCallback86, useEffect as useEffect51, useState as useState57 } from "react";
...
var Pause = (props) => /* @__PURE__ */ jsx166("svg", {
  ...props,
  "aria-hidden": "true",
  focusable: "false",
  "data-prefix": "fas",
...
var Play = (props) => /* @__PURE__ */ jsx167("svg", {
  ...props,
  "aria-hidden": "true",
  focusable: "false",
  "data-prefix": "fas",
...
// src/components/PlayPause.tsx
import { jsx as jsx170, jsxs as jsxs78, Fragment as Fragment22 } from "react/jsx-runtime";
var backStyle = {
  height: 18,
  color: "white"
};
...
var PlayPause = ({ playbackRate, loop, bufferStateDelayInMilliseconds }) => {
  ...
  const [showBufferIndicator, setShowBufferState] = useState57(false);
  const {
    playing,
    play,
    pause,
  ...
  return /* @__PURE__ */ jsxs78(Fragment22, {
    children: [
      /* @__PURE__ */ jsx170(ControlButton, {
        "aria-label": "Jump to beginning",
        title: "Jump to beginning",
        disabled: !videoConfig || isFirstFrame,
        onClick: jumpToStart,
        children: /* @__PURE__ */ jsx170(JumpToStart, {
          style: backStyle
        })
      }),
      /* @__PURE__ */ jsx170(ControlButton, {
        ...
        children: /* @__PURE__ */ jsx170(StepBack, {
      ...
      /* @__PURE__ */ jsx170(ControlButton, {
        ...
        children: playing ? showBufferIndicator ? /* @__PURE__ */ jsx170(PlayerInternals12.BufferingIndicator, {
          type: "studio"
        }) : /* @__PURE__ */ jsx170(Pause, {
          style: iconButton
        }) : /* @__PURE__ */ jsx170(Play, {
          style: iconButton
        })
      }),
      /* @__PURE__ */ jsx170(ControlButton, {
        ...
        children: /* @__PURE__ */ jsx170(StepForward, {
          style: forwardBackStyle
        })
      })
    ]
...
import { useCallback as useCallback87, useEffect as useEffect52 } from "react";
...
var PlaybackRateSelector = ({ playbackRate, setPlaybackRate }) => {
  ...
  const items = useMemo91(() => {
    ...
    const values = commonPlaybackRates.map((newPlaybackRate) => {
      return {
        ...
        keyHint: null,
        leftItem: String(playbackRate) === String(newPlaybackRate) ? /* @__PURE__ */ jsx171(Checkmark, {}) : null,
        subMenu: null,
        quickSwitcherLabel: null
      };
    });
  ...
  return /* @__PURE__ */ jsx171("div", {
    style: style9,
    "aria-label": accessibilityLabel5,
    children: /* @__PURE__ */ jsx171(Combobox, {
      title: accessibilityLabel5,
      style: comboStyle2,
...
import { useCallback as useCallback88, useContext as useContext51, useMemo as useMemo92 } from "react";
import { Internals as Internals42 } from "remotion";
import { jsx as jsx172, jsxs as jsxs79 } from "react/jsx-runtime";
var button3 = {
  paddingLeft: 7,
  paddingRight: 7,
  paddingTop: 7,
...
var RenderButton = () => {
  ...
  return /* @__PURE__ */ jsx172(Button, {
    ...
    children: /* @__PURE__ */ jsxs79(Row, {
      align: "center",
      children: [
        /* @__PURE__ */ jsx172(RenderIcon, {
          svgProps: iconStyle4
        }),
        /* @__PURE__ */ jsx172(Spacing, {
          x: 1
        }),
        /* @__PURE__ */ jsx172("span", {
          style: label7,
          children: "Render"
        })
      ]
...
import { useCallback as useCallback89, useContext as useContext52 } from "react";
import { Internals as Internals43 } from "remotion";

// src/icons/minus.tsx
import { jsx as jsx173 } from "react/jsx-runtime";
var Minus = (props) => {
  return /* @__PURE__ */ jsx173("svg", {
    ...props,
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 448 512",
    children: /* @__PURE__ */ jsx173("path", {
      fill: "currentColor",
  ...
  return /* @__PURE__ */ jsxs80("div", {
    ...
    children: [
      /* @__PURE__ */ jsx174(ControlButton, {
        ...
        children: /* @__PURE__ */ jsx174(Minus, {
          style: iconStyle4
        })
      }),
...
var PreviewToolbar = ({ readOnlyStudio, bufferStateDelayInMilliseconds }) => {
  ...
  const isStill = useIsStill();
  const [loop, setLoop] = useState58(loadLoopOption());
  const isFullscreenSupported = checkFullscreenSupport();
  const isMobileLayout = useMobileLayout();
  useEffect54(() => {
  ...
  return /* @__PURE__ */ jsxs81("div", {
    ...
    children: [
        ...
        children: [
          /* @__PURE__ */ jsxs81("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx175(TimelineZoomControls, {})
            ]
          }),
          /* @__PURE__ */ jsx175(Flex, {}),
          /* @__PURE__ */ jsx175(SizeSelector, {}),
          isStill || isVideoComposition ? /* @__PURE__ */ jsx175(PlaybackRateSelector, {
            setPlaybackRate,
            playbackRate
          }) : null
        ]
      ...
      isVideoComposition ? /* @__PURE__ */ jsxs81(Fragment23, {
        children: [
          /* @__PURE__ */ jsx175(Spacing, {
            x: 2
          }),
          /* @__PURE__ */ jsx175(PlayPause, {
            bufferStateDelayInMilliseconds,
            loop,
            playbackRate
          }),
          ...
          /* @__PURE__ */ jsx175(LoopToggle, {
            loop,
            setLoop
          }),
          /* @__PURE__ */ jsx175(MuteToggle, {
            muted: mediaMuted,
          ...
          /* @__PURE__ */ jsx175(TimelineInOutPointToggle, {}),
          /* @__PURE__ */ jsx175(Spacing, {
            x: 2
          })
        ]
      }) : null,
      /* @__PURE__ */ jsx175(CheckboardToggle, {}),
      /* @__PURE__ */ jsx175(Spacing, {
        x: 1
      }),
      isFullscreenSupported && /* @__PURE__ */ jsx175(FullScreenToggle, {}),
      /* @__PURE__ */ jsx175(Flex, {}),
      ...
      /* @__PURE__ */ jsxs81("div", {
        ...
        children: [
          /* @__PURE__ */ jsx175(Flex, {}),
          !isMobileLayout && /* @__PURE__ */ jsx175(FpsCounter, {
            playbackSpeed: playbackRate
          }),
          /* @__PURE__ */ jsx175(Spacing, {
            x: 2
          }),
          readOnlyStudio ? null : /* @__PURE__ */ jsx175(RenderButton, {}),
          /* @__PURE__ */ jsx175(Spacing, {
            x: 1.5
          })
        ]
      }),
      /* @__PURE__ */ jsx175(PlaybackKeyboardShortcutsManager, {
        setPlaybackRate
      }),
      /* @__PURE__ */ jsx175(PlaybackRatePersistor, {}),
      /* @__PURE__ */ jsx175("div", {
...
import { useMemo as useMemo93, useRef as useRef29, useState as useState59 } from "react";
...
var SplitterContext = React116.createContext({
  flexValue: 1,
  ref: { current: null },
  setFlexValue: () => {
    return;
...
var SplitterContainer = ({ orientation, children, defaultFlex, maxFlex, minFlex, id }) => {
  ...
  const [flexValue, setFlexValue] = useState59(initialTimelineFlex ?? defaultFlex);
  ...
  return /* @__PURE__ */ jsx176(SplitterContext.Provider, {
    value,
    children: /* @__PURE__ */ jsx176("div", {
      ref,
...
import { jsx as jsx177, jsxs as jsxs82, Fragment as Fragment24 } from "react/jsx-runtime";
...
import { useContext as useContext55, useEffect as useEffect55, useRef as useRef30, useState as useState60 } from "react";
...
var SplitterHandle = ({ allowToCollapse, onCollapse }) => {
  ...
  const [lastPointerUp, setLastPointerUp] = useState60(() => Date.now());
...
// src/components/TopPanel.tsx
import { jsx as jsx179, jsxs as jsxs83 } from "react/jsx-runtime";
var container36 = {
  height: "100%",
  width: "100%",
  display: "flex",
    ...
    children: [
      /* @__PURE__ */ jsx179("div", {
        ...
        children: /* @__PURE__ */ jsxs83(SplitterContainer, {
          ...
          orientation: "vertical",
          children: [
            actualStateLeft === "expanded" ? isMobileLayout ? /* @__PURE__ */ jsx179(MobilePanel, {
              onClose: onCollapseLeft,
              children: /* @__PURE__ */ jsx179(ExplorerPanel, {
                readOnlyStudio
              })
            }) : /* @__PURE__ */ jsx179(SplitterElement, {
              sticky: null,
              type: "flexer",
              children: /* @__PURE__ */ jsx179(ExplorerPanel, {
                readOnlyStudio
            ...
            actualStateLeft === "expanded" ? /* @__PURE__ */ jsx179(SplitterHandle, {
                ...
                children: [
                  /* @__PURE__ */ jsx179(SplitterElement, {
                    ...
                    children: /* @__PURE__ */ jsx179("div", {
                      ...
                      children: /* @__PURE__ */ jsx179(CanvasIfSizeIsAvailable, {})
                    })
                  }),
                  actualStateRight === "expanded" ? /* @__PURE__ */ jsx179(SplitterHandle, {
                    allowToCollapse: "right",
                    onCollapse: onCollapseRight
                  }) : null,
                  actualStateRight === "expanded" ? isMobileLayout ? /* @__PURE__ */ jsx179(MobilePanel, {
                    onClose: onCollapseRight,
                    children: /* @__PURE__ */ jsx179(OptionsPanel, {
                      readOnlyStudio
                    })
                  }) : /* @__PURE__ */ jsx179(SplitterElement, {
                    sticky: null,
      ...
      /* @__PURE__ */ jsx179(PreviewToolbar, {
        bufferStateDelayInMilliseconds,
        readOnlyStudio
      }),
      /* @__PURE__ */ jsx179(CurrentCompositionKeybindings, {
        readOnlyStudio
      }),
      /* @__PURE__ */ jsx179(TitleUpdater, {})
    ]
  });
};

// src/components/SidebarCollapserControls.tsx
import { jsx as jsx180, jsxs as jsxs84, Fragment as Fragment25 } from "react/jsx-runtime";
var style9 = {
  width: 16,
  height: 16,
  minWidth: 16,
...
var UpdateCheck = () => {
  const [info, setInfo] = useState61(null);
  const { setSelectedModal } = useContext58(ModalsContext);
  const { tabIndex } = useZIndex();
  const [knownBugs, setKnownBugs] = useState61(null);
  ...
  return /* @__PURE__ */ jsx181("button", {
    tabIndex,
    style: dynButtonStyle,
    onClick: openModal,
    type: "button",
    title: hasKnownBugs ? "Bugfixes available" : "Update available",
    children: hasKnownBugs ? "Bugfixes available" : /* @__PURE__ */ jsx181("svg", {
      xmlns: "http://www.w3.org/2000/svg",
      style: {
        height: 16,
        width: 16
...
var MenuToolbar = ({ readOnlyStudio }) => {
  const [selected, setSelected] = useState62(null);
  const mobileLayout = useMobileLayout();
  ...
  return /* @__PURE__ */ jsxs85(Row, {
    ...
    children: [
      /* @__PURE__ */ jsxs85("div", {
        ...
        children: [
          structure.map((s) => {
            return /* @__PURE__ */ jsx182(MenuItem, {
          ...
          readOnlyStudio ? null : /* @__PURE__ */ jsx182(UpdateCheck, {})
        ]
      }),
      /* @__PURE__ */ jsx182("div", {
        style: flex2
      }),
      /* @__PURE__ */ jsx182(MenuBuildIndicator, {}),
      /* @__PURE__ */ jsx182("div", {
        style: flex2
      }),
      /* @__PURE__ */ jsx182("div", {
        style: fixedWidthRight,
        children: /* @__PURE__ */ jsx182(SidebarCollapserControls, {})
      }),
      /* @__PURE__ */ jsx182(Spacing, {
        x: 1
      })
    ]
  });
...
import { useContext as useContext67, useMemo as useMemo108 } from "react";
...
import { createRef as createRef11, useContext as useContext59 } from "react";
import { Internals as Internals45 } from "remotion";
import { jsx as jsx183, jsxs as jsxs87, Fragment as Fragment26 } from "react/jsx-runtime";
var areaHighlight = {
  position: "absolute",
...
var inMarkerAreaRef = createRef11();
...
var TimelineInOutPointer = () => {
  ...
  return /* @__PURE__ */ jsxs87(Fragment26, {
    children: [
      inFrame !== null && /* @__PURE__ */ jsx183("div", {
        ref: inMarkerAreaRef,
        style: {
          ...areaHighlight,
          left: 0,
      ...
      outFrame !== null && /* @__PURE__ */ jsx183("div", {
...
import { createRef as createRef12, useContext as useContext60, useMemo as useMemo98 } from "react";
...
var inPointerHandle = createRef12();
...
var TimelineInOutPointerHandle = ({
  ...
  return /* @__PURE__ */ jsx184(InnerTimelineInOutPointerHandle, {
    atFrame,
    dragging,
    timelineWidth,
    type
...
var TimelineDragHandler = () => {
  ...
  return /* @__PURE__ */ jsx185("div", {
    ref: sliderAreaRef,
    style: containerStyle2,
    children: video ? /* @__PURE__ */ jsx185(Inner2, {}) : null
  });
};
var Inner2 = () => {
  ...
  const [inOutDragging, setInOutDragging] = useState63({
    dragging: false
  });
  ...
  const { inFrame, outFrame } = useTimelineInOutFramePosition();
  const { setInAndOutFrames } = useTimelineSetInOutFramePosition();
  const [dragging, setDragging] = useState63({
    dragging: false
  });
  ...
  return /* @__PURE__ */ jsxs88("div", {
    ...
    children: [
      ...
      inFrame !== null && /* @__PURE__ */ jsx185(ContextMenu, {
        values: inContextMenu,
        children: /* @__PURE__ */ jsx185(TimelineInOutPointerHandle, {
          type: "in",
          atFrame: inFrame,
          dragging: inOutDragging.dragging === "in"
        })
      }),
      outFrame !== null && /* @__PURE__ */ jsx185(ContextMenu, {
...
import { useCallback as useCallback97, useContext as useContext63, useMemo as useMemo101 } from "react";
...
var TimelineLayerEye = ({ onInvoked, hidden, type }) => {
  const renderAction = useCallback95((color) => {
    ...
    if (type === "speaker") {
      return /* @__PURE__ */ jsx186("svg", {
        viewBox: "0 0 10 14",
        fill: "none",
        style: speakerIcon,
        children: /* @__PURE__ */ jsx186("path", {
...
var TimelineStack = ({ isCompact, sequence }) => {
  ...
  const [stackHovered, setStackHovered] = useState64(false);
  const [titleHovered, setTitleHovered] = useState64(false);
  const [opening, setOpening] = useState64(false);
  const selectAsset = useSelectAsset();
  ...
  return /* @__PURE__ */ jsxs89(Fragment27, {
    children: [
      ...
      isCompact || !originalLocation ? null : /* @__PURE__ */ jsx187("div", {
      ...
      opening ? /* @__PURE__ */ jsxs89(Fragment27, {
        children: [
          /* @__PURE__ */ jsx187(Spacing, {
            x: 0.5
          }),
          /* @__PURE__ */ jsx187(Spinner, {
            duration: 0.5,
            size: 12
          })
        ]
...
// src/components/Timeline/TimelineListItem.tsx
import { jsx as jsx188, jsxs as jsxs90 } from "react/jsx-runtime";
var SPACING = 5;
var outer2 = {
...
var TimelineListItem = ({ nestedDepth, sequence, isCompact }) => {
  ...
  return /* @__PURE__ */ jsxs90("div", {
    style: outer2,
    children: [
      /* @__PURE__ */ jsx188(TimelineLayerEye, {
      ...
      sequence.parent && nestedDepth > 0 ? /* @__PURE__ */ jsx188("div", {
        style: space
      }) : null,
      /* @__PURE__ */ jsx188(TimelineStack, {
        sequence,
        isCompact
      })
    ]
...
import { jsx as jsx189, jsxs as jsxs91 } from "react/jsx-runtime";
var text = {
  color: "white",
  display: "flex",
  flexDirection: "row",
...
var TimeValue = () => {
  ...
  useImperativeHandle14(Internals48.timeValueRef, () => ({
    goToFrame: () => {
      ref.current?.click();
    },
    seek,
  ...
  return /* @__PURE__ */ jsxs91("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx189(Flex, {}),
      /* @__PURE__ */ jsx189(InputDragger, {
        ref,
        value: frame2,
        onTextChange,
        onValueChange,
...
var TimelineTimePlaceholders = () => {
  return /* @__PURE__ */ jsx190("div", {
    style: timeValue,
    children: /* @__PURE__ */ jsx190(TimeValue, {})
  });
};
...
var Inner3 = ({ windowWidth, durationInFrames, fps }) => {
  ...
  return /* @__PURE__ */ jsx190("div", {
    ...
    children: ticks.map((t) => {
      return /* @__PURE__ */ jsx190("div", {
        style: t.style,
        children: t.showTime ? /* @__PURE__ */ jsx190("div", {
          style: tickLabel,
...
var TimelineList = ({ timeline }) => {
  ...
  return /* @__PURE__ */ jsxs92("div", {
    ...
    style: container41,
    children: [
      /* @__PURE__ */ jsx191(TimelineTimePadding, {}),
      timeline.map((track) => {
        return /* @__PURE__ */ jsx191("div", {
          children: /* @__PURE__ */ jsx191(TimelineListItem, {
...
import { useMemo as useMemo107 } from "react";

// src/components/Timeline/TimelineSequence.tsx
import { useContext as useContext66, useMemo as useMemo106, useState as useState67 } from "react";
...
import { useEffect as useEffect64, useMemo as useMemo105, useRef as useRef35, useState as useState65 } from "react";
...
// src/components/AudioWaveform.tsx
import { jsx as jsx194, jsxs as jsxs93 } from "react/jsx-runtime";
var container43 = {
  display: "flex",
  flexDirection: "row",
  alignItems: "flex-end",
...
var AudioWaveform = ({
  ...
  const [metadata, setMetadata] = useState65(null);
  ...
  return /* @__PURE__ */ jsxs93("div", {
    ...
    children: [
      normalized.map((w) => {
        return /* @__PURE__ */ jsx194(AudioWaveformBar, {
          amplitude: w.amplitude * (typeof volume === "number" ? volume : 1)
        }, w.index);
      }),
      /* @__PURE__ */ jsx194("canvas", {
        ref: canvas,
        style: canvasStyle,
...
import { jsx as jsx195, jsxs as jsxs94 } from "react/jsx-runtime";
var width = {
  width: 30,
  flexDirection: "row",
  display: "flex",
...
var LoopedTimelineIndicator = ({ loops }) => {
  return /* @__PURE__ */ jsx196(AbsoluteFill5, {
    style: row6,
    children: new Array(loops).fill(true).map((_l, i) => {
      return /* @__PURE__ */ jsxs95(React135.Fragment, {
        children: [
          /* @__PURE__ */ jsx196(Flex, {}),
          i === loops - 1 ? null : /* @__PURE__ */ jsx196(LoopedIndicator, {})
        ]
      }, i);
    })
  });
...
import { useEffect as useEffect65, useRef as useRef36, useState as useState66 } from "react";
...
var TimelineVideoInfo = ({ src }) => {
  const mountState = useRef36({ isMounted: true });
  const [videoMetadata, setVideoMetadata] = useState66(null);
  useEffect65(() => {
  ...
  return /* @__PURE__ */ jsx198("div", {
    style: containerStyle2,
    children: /* @__PURE__ */ jsx198("svg", {
      style: svgStyle2,
      role: "img",
      viewBox: "0 0 576 512",
      children: /* @__PURE__ */ jsx198("path", {
        style: pathStyle,
        fill: "currentColor",
...
// src/components/Timeline/TimelineSequence.tsx
import { jsx as jsx199, jsxs as jsxs96 } from "react/jsx-runtime";
...
var TimelineSequence = ({ s }) => {
  ...
  return /* @__PURE__ */ jsx199(Inner4, {
    windowWidth,
    s
  });
};
var Inner4 = ({ s, windowWidth }) => {
  const [maxMediaDuration, setMaxMediaDuration] = useState67(Infinity);
  ...
  return /* @__PURE__ */ jsxs96("div", {
    ...
    title: s.displayName,
    children: [
      premountWidth ? /* @__PURE__ */ jsx199("div", {
        style: {
          width: premountWidth,
          height: "100%",
      ...
      s.type === "video" ? /* @__PURE__ */ jsx199(TimelineVideoInfo, {
        src: s.src
      }) : null,
...
// src/components/Timeline/TimelineTracks.tsx
import { jsx as jsx200, jsxs as jsxs97 } from "react/jsx-runtime";
var content = {
...
var TimelineTracks = ({ timeline, hasBeenCut }) => {
  const inner2 = useMemo107(() => {
    return {
      height: TIMELINE_LAYER_HEIGHT,
      marginBottom: TIMELINE_ITEM_BORDER_BOTTOM
    };
  }, []);
  const timelineStyle = useMemo107(() => {
    return {
      ...timelineContent,
      width: 100 + "%"
    };
  ...
  return /* @__PURE__ */ jsxs97("div", {
    ...
    children: [
      /* @__PURE__ */ jsxs97("div", {
        style: content,
        children: [
          /* @__PURE__ */ jsx200(TimelineTimePadding, {}),
          timeline.map((track) => {
            ...
            return /* @__PURE__ */ jsx200("div", {
              style: inner2,
              children: /* @__PURE__ */ jsx200(TimelineSequence, {
                s: track.sequence
              })
            }, track.sequence.id);
          })
      ...
      hasBeenCut ? /* @__PURE__ */ jsx200(MaxTimelineTracksReached, {}) : null
    ]
  });
};
...
var Timeline = () => {
  ...
  return /* @__PURE__ */ jsx201("div", {
    ...
    children: /* @__PURE__ */ jsx201(TimelineWidthProvider, {
        ...
        children: /* @__PURE__ */ jsxs98(SplitterContainer, {
          ...
          children: [
            /* @__PURE__ */ jsx201(SplitterElement, {
              type: "flexer",
              sticky: /* @__PURE__ */ jsx201(TimelineTimePlaceholders, {}),
              children: /* @__PURE__ */ jsx201(TimelineList, {
                timeline: shown
              })
            }),
            ...
            /* @__PURE__ */ jsx201(SplitterElement, {
              ...
              children: /* @__PURE__ */ jsxs98(TimelineScrollable, {
                children: [
                  /* @__PURE__ */ jsx201(TimelineTracks, {
                    timeline: shown,
                    hasBeenCut
                  }),
                  /* @__PURE__ */ jsx201(TimelineInOutPointer, {}),
                  /* @__PURE__ */ jsx201(TimelinePlayCursorSyncer, {}),
                  /* @__PURE__ */ jsx201(TimelineDragHandler, {}),
                  /* @__PURE__ */ jsx201(TimelineTimeIndicators, {}),
                  /* @__PURE__ */ jsx201(TimelineSlider, {})
                ]
              })
            })
          ]
...
// src/components/EditorContent.tsx
import { jsx as jsx202, jsxs as jsxs99, Fragment as Fragment28 } from "react/jsx-runtime";
var noop3 = () => {
  return;
};
var container45 = {
...
var EditorContent = ({ readOnlyStudio, children }) => {
  ...
  return /* @__PURE__ */ jsxs99("div", {
    style: container45,
    children: [
      /* @__PURE__ */ jsx202(InitialCompositionLoader, {}),
      /* @__PURE__ */ jsx202(MenuToolbar, {
        readOnlyStudio
      }),
      /* @__PURE__ */ jsxs99(SplitterContainer, {
        ...
        defaultFlex: 0.75,
        children: [
          /* @__PURE__ */ jsx202(SplitterElement, {
            sticky: null,
            type: "flexer",
            children
          }),
          onlyTopPanel ? null : /* @__PURE__ */ jsxs99(Fragment28, {
            children: [
              /* @__PURE__ */ jsx202(SplitterHandle, {
                allowToCollapse: "none",
                onCollapse: noop3
              }),
              /* @__PURE__ */ jsx202(SplitterElement, {
                sticky: null,
                type: "anti-flexer",
                children: /* @__PURE__ */ jsx202(Timeline, {})
              })
            ]
          })
        ]
...
import React143, { useCallback as useCallback100, useContext as useContext71, useEffect as useEffect67 } from "react";
...
var InstallablePackageComp = ({ isInstalled, pkg, link, description }) => {
  return /* @__PURE__ */ jsxs100("div", {
    ...
    children: [
      ...
      " ",
      isInstalled ? /* @__PURE__ */ jsx203("span", {
...
import { useMemo as useMemo109 } from "react";
...
import { useCallback as useCallback99, useContext as useContext70 } from "react";
...
var DismissableModal = ({ children }) => {
  ...
  return /* @__PURE__ */ jsx206(ModalContainer, {
    onOutsideClick: onQuit,
    onEscape: onQuit,
    children
  });
...
var InstallPackageModal = ({ packageManager }) => {
  const [state, setState] = React143.useState({ type: "idle" });
  const [map, setMap] = React143.useState({});
  ...
  return /* @__PURE__ */ jsxs101(DismissableModal, {
    children: [
      ...
      /* @__PURE__ */ jsx207("div", {
        ...
        }) : state.type === "restarting" ? /* @__PURE__ */ jsx207("div", {
          style: text2,
          ...
          children: Object.entries(installableMap).filter(([, install]) => install).map(([pkgShort]) => {
            ...
            return /* @__PURE__ */ jsxs101(Row, {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx207(InstallablePackageComp, {
                  description,
                  isInstalled,
                  link,
                  pkg
      ...
      /* @__PURE__ */ jsx207(ModalFooterContainer, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs101(ModalButton, {
              ...
              children: [
                ...
                disabled ? null : /* @__PURE__ */ jsx207(ShortcutHint, {
                  keyToPress: "↵",
                  cmdOrCtrl: true
                })
              ]
...
import { useCallback as useCallback102, useContext as useContext74, useMemo as useMemo111 } from "react";

// src/components/RenderModal/ResolveCompositionBeforeModal.tsx
import React144, { useContext as useContext72, useEffect as useEffect68, useMemo as useMemo110 } from "react";
import { Internals as Internals55 } from "remotion";
import { jsx as jsx208, jsxs as jsxs102 } from "react/jsx-runtime";
...
var ResolvedCompositionContext = React144.createContext(null);
var ResolveCompositionBeforeModal = ({ compositionId, children }) => {
  ...
  if (!resolved || resolved.type === "loading") {
    return /* @__PURE__ */ jsx208(RunningCalculateMetadata, {});
  }
  if (resolved.type === "error") {
    return /* @__PURE__ */ jsxs102("div", {
      style: loaderContainer2,
      children: [
        /* @__PURE__ */ jsx208(Spacing, {
          y: 2
        }),
  ...
  return /* @__PURE__ */ jsx208(ResolvedCompositionContext.Provider, {
    value,
    children
  });
};
...
import { useCallback as useCallback101, useContext as useContext73, useEffect as useEffect69, useState as useState68 } from "react";
...
var CodemodFooter = ({
  ...
  const [submitting, setSubmitting] = useState68(false);
  const { setSelectedModal } = useContext73(ModalsContext);
  const [codemodStatus, setCanApplyCodemod] = useState68({
    type: "loading"
  });
  const [projectInfo, setProjectInfo] = useState68(null);
  useEffect69(() => {
    const controller = new AbortController;
  ...
  return /* @__PURE__ */ jsxs104(Row, {
    align: "center",
    children: [
      /* @__PURE__ */ jsx210(CodemodDiffPreview, {
        status: codemodStatus
      }),
      /* @__PURE__ */ jsx210(Flex, {}),
...
// src/components/NewComposition/DeleteComposition.tsx
import { jsx as jsx211, jsxs as jsxs105, Fragment as Fragment29 } from "react/jsx-runtime";
var content3 = {
  padding: 16,
  fontSize: 14,
  flex: 1,
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs105("form", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx211(ModalFooterContainer, {
            children: /* @__PURE__ */ jsx211(CodemodFooter, {
...
var DeleteComposition = ({ compositionId }) => {
  return /* @__PURE__ */ jsx211(DismissableModal, {
    children: /* @__PURE__ */ jsx211(ResolveCompositionBeforeModal, {
      compositionId,
      children: /* @__PURE__ */ jsx211(DeleteCompositionLoaded, {
        compositionId
      })
    })
  });
...
import { useCallback as useCallback104, useContext as useContext75, useMemo as useMemo112, useState as useState69 } from "react";
...
import { jsx as jsx212, jsxs as jsxs106, Fragment as Fragment30 } from "react/jsx-runtime";
...
// src/components/NewComposition/DuplicateComposition.tsx
import { jsx as jsx213, jsxs as jsxs107, Fragment as Fragment31 } from "react/jsx-runtime";
var content4 = {
  padding: 12,
  paddingRight: 12,
  flex: 1,
...
var DuplicateCompositionLoaded = ({ initialType }) => {
  ...
  const [initialCompType] = useState69(initialType);
  ...
  const [selectedFrameRate, setFrameRate] = useState69(resolved.result.fps);
  const { compositions } = useContext75(Internals57.CompositionManager);
  const [type, setType] = useState69(initialCompType);
  ...
  const [size4, setSize] = useState69(() => ({
    width: resolved.result.width,
    height: resolved.result.height
  }));
  const [durationInFrames, setDurationInFrames] = useState69(resolved.result.durationInFrames);
            ...
            children: [
              initialCompType === "composition" ? /* @__PURE__ */ jsxs107("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx213("div", {
                    style: rightRow,
                    children: /* @__PURE__ */ jsx213(Combobox, {
              ...
              type === "composition" && hadDurationDefined ? /* @__PURE__ */ jsx213(NewCompDuration, {
                durationInFrames,
                setDurationInFrames
              }) : null,
              type === "composition" && hadFpsDefined ? /* @__PURE__ */ jsxs107("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx213("div", {
                    style: rightRow,
                    children: /* @__PURE__ */ jsx213(InputDragger, {
                      type: "number",
...
var DuplicateComposition = ({ compositionId, compositionType }) => {
  return /* @__PURE__ */ jsx213(DismissableModal, {
    children: /* @__PURE__ */ jsx213(ResolveCompositionBeforeModal, {
      compositionId,
      children: /* @__PURE__ */ jsx213(DuplicateCompositionLoaded, {
...
import { useCallback as useCallback105, useContext as useContext76, useMemo as useMemo113, useState as useState70 } from "react";
import { Internals as Internals58 } from "remotion";
import { jsx as jsx214, jsxs as jsxs108, Fragment as Fragment32 } from "react/jsx-runtime";
var content5 = {
  padding: 12,
  paddingRight: 12,
  flex: 1,
...
var RenameCompositionLoaded = () => {
  ...
  const [newId, setName] = useState70(() => {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs108("form", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx214(ModalFooterContainer, {
            children: /* @__PURE__ */ jsx214(CodemodFooter, {
...
var RenameComposition = ({ compositionId }) => {
  return /* @__PURE__ */ jsx214(DismissableModal, {
    children: /* @__PURE__ */ jsx214(ResolveCompositionBeforeModal, {
      compositionId,
      children: /* @__PURE__ */ jsx214(RenameCompositionLoaded, {})
    })
  });
};
...
import { jsx as jsx216, jsxs as jsxs109 } from "react/jsx-runtime";
var left3 = {
  width: 85,
  paddingTop: 8,
  paddingBottom: 8
                ...
                children: [
                  /* @__PURE__ */ jsxs109("div", {
                    ...
                    children: [
                      /* @__PURE__ */ jsx216("kbd", {
                        style: key4,
                        children: /* @__PURE__ */ jsx216(ShiftIcon, {})
                      }),
                      ...
                      /* @__PURE__ */ jsx216("kbd", {
                        style: key4,
                        children: /* @__PURE__ */ jsx216(ArrowLeft, {})
                      })
                    ]
                  }),
                  /* @__PURE__ */ jsx216("div", {
              ...
              /* @__PURE__ */ jsxs109(Row, {
                ...
                children: [
                  /* @__PURE__ */ jsx216("div", {
                    ...
                    children: /* @__PURE__ */ jsx216("kbd", {
                      style: key4,
                      children: /* @__PURE__ */ jsx216(ArrowRight, {})
                    })
                  }),
                  /* @__PURE__ */ jsx216("div", {
                    style: right2,
...
import { useEffect as useEffect70, useMemo as useMemo114, useRef as useRef37, useState as useState71 } from "react";
import { jsx as jsx218, jsxs as jsxs111, Fragment as Fragment33 } from "react/jsx-runtime";
var container49 = {
  paddingLeft: 16,
  paddingRight: 16,
  display: "flex",
...
var QuickSwitcherResult = ({ result, selected }) => {
  const [hovered, setIsHovered] = useState71(false);
  ...
  return /* @__PURE__ */ jsxs111("div", {
    ...
    children: [
      result.type === "composition" ? result.compositionType === "still" ? /* @__PURE__ */ jsx218(StillIcon, {
        color: selected ? "white" : LIGHT_TEXT,
        style: iconStyle6
      }) : /* @__PURE__ */ jsx218(FilmIcon, {
        color: selected ? "white" : LIGHT_TEXT,
        style: iconStyle6
      }) : null,
...
var QuickSwitcherContent = ({ initialMode, invocationTimestamp, readOnlyStudio }) => {
  ...
  const [state, setState] = useState72(() => {
    return {
  ...
  const onArrowDown = useCallback106(() => {
    setState((s) => {
      return {
        ...s,
  ...
  const onArrowUp = useCallback106(() => {
    setState((s) => {
      return {
        ...s,
        selectedIndex: s.selectedIndex - 1
  ...
  const onTextChange = useCallback106((e) => {
  ...
  const onActionsSelected = useCallback106(() => {
    setState((s) => ({
  ...
  const onCompositionsSelected = useCallback106(() => {
    setState((s) => ({
      query: stripQuery(s.query),
      selectedIndex: 0
    }));
  ...
  const onDocSearchSelected = useCallback106(() => {
    setState((s) => ({
      query: `? ${stripQuery(s.query)}`,
      selectedIndex: 0
    }));
  ...
  const container50 = useMemo115(() => {
    return {
      width: showKeyboardShortcuts ? 800 : 500
    };
  }, [showKeyboardShortcuts]);
  const results = useMemo115(() => {
  ...
  return /* @__PURE__ */ jsxs112("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx219("div", {
        style: results,
        className: VERTICAL_SCROLLBAR_CLASSNAME,
        children: showKeyboardShortcuts ? /* @__PURE__ */ jsx219(KeyboardShortcutsExplainer, {}) : showSearchLoadingState ? null : resultsArray.length === 0 ? /* @__PURE__ */ jsx219(QuickSwitcherNoResults, {
          mode,
          query: actualQuery
        }) : resultsArray.map((result, i) => {
          return /* @__PURE__ */ jsx219(QuickSwitcherResult, {
...
var QuickSwitcher = ({ initialMode, invocationTimestamp, readOnlyStudio }) => {
  return /* @__PURE__ */ jsx220(DismissableModal, {
    children: /* @__PURE__ */ jsx220(QuickSwitcherContent, {
      readOnlyStudio,
      invocationTimestamp,
      initialMode
    })
...
import { useMemo as useMemo116, useState as useState73 } from "react";
var useRenderModalSections = (renderMode, codec) => {
  const [selectedTab, setTab] = useState73("general");
  const shownTabs = useMemo116(() => {
    if (renderMode === "audio") {
...
var AudioIcon = (props) => /* @__PURE__ */ jsx221("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
...
var PicIcon = (props) => /* @__PURE__ */ jsx223("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
...
var GearIcon = (props) => /* @__PURE__ */ jsx224("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
...
var GifIcon = (props) => /* @__PURE__ */ jsx225("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 576 512",
  ...props,
  children: /* @__PURE__ */ jsx225("path", {
    fill: "currentcolor",
...
import { useCallback as useCallback107, useMemo as useMemo117, useState as useState74 } from "react";
...
var VerticalTab = ({ children, onClick, style: style11, selected }) => {
  ...
  const definiteStyle = useMemo117(() => {
    return {
      ...selectorButton2,
...
import { useCallback as useCallback108, useEffect as useEffect72, useMemo as useMemo118, useState as useState75 } from "react";
...
var CliCopyButton = ({
  ...
  const [copied, setCopied] = useState75(false);
  const [hovered, setHovered] = useState75(false);
  const fillColor = useMemo118(() => {
    return hovered ? "white" : LIGHT_TEXT;
  }, [hovered]);
  const clipboardIcon = /* @__PURE__ */ jsx227(ClipboardIcon, {
    color: fillColor,
    style: svgStyle3
  });
  const checkSvg = /* @__PURE__ */ jsx227("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 448 512",
    style: svgStyle3,
    children: /* @__PURE__ */ jsx227("path", {
      fill: fillColor,
      d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"
    })
  });
  const onPointerEnter = useCallback108(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback108(() => {
    setHovered(false);
  }, []);
  useEffect72(() => {
    if (!copied) {
  ...
  return copied ? /* @__PURE__ */ jsx227("span", {
    style: copiedStyle,
    children: checkSvg
        ...
        children: [
          /* @__PURE__ */ jsxs113("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx228("div", {
                style: copyWrapper,
                children: /* @__PURE__ */ jsx228(CliCopyButton, {
...
var OptionExplainerBubble = ({ id }) => {
  ...
  return /* @__PURE__ */ jsx229(InfoBubble, {
    title: "Learn more about this option",
    children: /* @__PURE__ */ jsx229(OptionExplainer, {
      option
    })
  });
};
...
// src/components/RenderModal/NumberSetting.tsx
import { jsx as jsx230, jsxs as jsxs114, Fragment as Fragment35 } from "react/jsx-runtime";
var NumberSetting = ({ name, value, step, hint, onValueChanged, max, min, formatter }) => {
  ...
  const onValueChange = useCallback109((newConcurrency) => {
  ...
  return /* @__PURE__ */ jsxs114("div", {
    ...
    children: [
        ...
        children: [
          ...
          hint ? /* @__PURE__ */ jsxs114(Fragment35, {
            children: [
              ...
              /* @__PURE__ */ jsx230(OptionExplainerBubble, {
                id: hint
              })
            ]
          }) : null
      ...
      /* @__PURE__ */ jsx230("div", {
        style: rightRow,
        children: /* @__PURE__ */ jsx230(RightAlignInput, {
          children: /* @__PURE__ */ jsx230(InputDragger, {
            value,
...
var useCrfState = (codec) => {
  const [state, setState] = useState76(() => getDefaultCrfState());
...
var CrfSetting = ({ crf, setCrf, min, max, option }) => {
  return /* @__PURE__ */ jsx231(NumberSetting, {
    min,
    max,
    name: "CRF",
...
import { useCallback as useCallback113, useMemo as useMemo119 } from "react";
...
import React154, { useCallback as useCallback111 } from "react";

// src/components/RenderModal/InlineEyeIcon.tsx
import { useCallback as useCallback110 } from "react";
...
var InlineEyeButton = ({ onClick, enabled }) => {
  const renderAction = useCallback110((color) => {
    return enabled ? /* @__PURE__ */ jsx232("svg", {
      style: clearIcon2,
      viewBox: "0 0 640 512",
  ...
  return /* @__PURE__ */ jsx232(InlineAction, {
    renderAction,
    onClick
  });
};
...
// src/components/RenderModal/EnvInput.tsx
import { jsx as jsx233, jsxs as jsxs115, Fragment as Fragment36 } from "react/jsx-runtime";
var input3 = {
  flex: 1,
  width: "100%"
};
...
var EnvInput = ({
  ...
  const [showInPlainText, setShowInPlainText] = React154.useState(false);
  const [initialWarningKeyMissing, setKeyWarningEligible] = React154.useState(() => {
    return envKey.trim() === "" && envVal.trim() !== "";
  });
  const [initialWarningValMissing, setValueWarningEligible] = React154.useState(() => {
    return envKey.trim() !== "" && envVal.trim() === "";
  });
  ...
  const togglePlainText = useCallback111(() => {
    setShowInPlainText((prev) => !prev);
  }, []);
  const handleKeyChange = useCallback111((e) => {
    onEnvKeyChange(index, e.target.value);
  }, [index, onEnvKeyChange]);
  const handleValueChange = useCallback111((e) => {
    onEnvValChange(index, e.target.value);
  }, [index, onEnvValChange]);
  const makeKeyWarningEligible = useCallback111(() => {
    setKeyWarningEligible(true);
  }, []);
  const makeValueWarningEligible = useCallback111(() => {
    ...
    children: [
      /* @__PURE__ */ jsxs115(Row, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx233(InlineEyeButton, {
            enabled: !showInPlainText,
            onClick: togglePlainText
          }),
          /* @__PURE__ */ jsx233(InlineRemoveButton, {
            onClick: handleDelete
          })
        ]
      }),
      isNodeEnvKey ? /* @__PURE__ */ jsx233("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx233(ValidationMessage, {
          align: "flex-start",
          type: "warning",
          message: "NODE_ENV will be overwritten by Remotion during the render process."
        })
      }) : null,
      isDuplicate ? /* @__PURE__ */ jsx233("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx233(ValidationMessage, {
          align: "flex-start",
          type: "warning",
      ...
      isKeyMissing ? /* @__PURE__ */ jsx233("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx233(ValidationMessage, {
          align: "flex-start",
          type: "warning",
      ...
      isValMissing ? /* @__PURE__ */ jsx233("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx233(ValidationMessage, {
          align: "flex-start",
          type: "warning",
...
// src/components/RenderModal/RenderModalEnvironmentVariables.tsx
import { jsx as jsx234, jsxs as jsxs116 } from "react/jsx-runtime";
var title6 = {
  fontSize: 14,
  fontWeight: "bold",
  color: LIGHT_TEXT,
...
var RenderModalEnvironmentVariables = ({ envVariables, setEnvVariables }) => {
  const onEnvValChange = useCallback112((index, value) => {
  ...
  const onEnvKeyChange = useCallback112((index, value) => {
    setEnvVariables((oldEnv) => {
      const newEnv = [...oldEnv];
  ...
  const onDelete = useCallback112((index) => {
    setEnvVariables((oldEnv) => oldEnv.filter((_, idx) => idx !== index));
  }, [setEnvVariables]);
  const addField = useCallback112(() => {
  ...
  return /* @__PURE__ */ jsxs116("div", {
    ...
    children: [
      ...
      envVariables.map((env, i) => {
        ...
        return /* @__PURE__ */ jsx234(EnvInput, {
          onEnvKeyChange,
          onEnvValChange,
          envKey: env[0],
          envVal: env[1],
...
var RenderModalHr = () => {
  return /* @__PURE__ */ jsx235("div", {
    style: hrStyle
  });
};

// src/components/RenderModal/RenderModalAdvanced.tsx
import { jsx as jsx236, jsxs as jsxs117 } from "react/jsx-runtime";
var container52 = {
  flex: 1,
  overflowY: "auto"
};
var RenderModalAdvanced = ({
  ...
  const extendedOpenGlOptions = useMemo119(() => {
    return [
      "angle",
      "egl",
      "swangle",
  ...
  const toggleCustomOffthreadVideoThreads = useCallback113(() => {
  ...
  const toggleCustomUserAgent = useCallback113(() => {
  ...
  const onDisallowParallelEncodingChanged = useCallback113((e) => {
    setDisallowParallelEncoding(e.target.checked);
  }, [setDisallowParallelEncoding]);
  const onDisableWebSecurityChanged = useCallback113((e) => {
    setDisableWebSecurity(e.target.checked);
  }, [setDisableWebSecurity]);
  const onEnableMultiProcessOnLinux = useCallback113((e) => {
    setChromiumMultiProcessOnLinux(e.target.checked);
  }, [setChromiumMultiProcessOnLinux]);
  const onIgnoreCertificatErrors = useCallback113((e) => {
    setIgnoreCertificateErrors(e.target.checked);
  }, [setIgnoreCertificateErrors]);
  const onHeadless = useCallback113((e) => {
    setHeadless(e.target.checked);
  }, [setHeadless]);
  const onUserAgentChanged = useCallback113((e) => {
    setUserAgent(e.target.value);
  }, [setUserAgent]);
  const onPlayBeepSound = useCallback113((e) => {
    setBeep(e.target.checked);
  }, [setBeep]);
  const onReproToggle = useCallback113((e) => {
    setRepro(e.target.checked);
  }, [setRepro]);
  const openGlOptions = useMemo119(() => {
    return extendedOpenGlOptions.map((option) => {
      return {
        label: option === "default" ? "Default" : option,
        onClick: () => setOpenGlOption(option),
        key: option,
        leftItem: openGlOption === option ? /* @__PURE__ */ jsx236(Checkmark, {}) : null,
        id: option,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  const chromeModeOptions = useMemo119(() => {
    return BrowserSafeApis3.validChromeModeOptions.map((option) => {
      return {
        label: option,
        onClick: () => setChromeModeOption(option),
        key: option,
        leftItem: chromeModeOption === option ? /* @__PURE__ */ jsx236(Checkmark, {}) : null,
        id: option,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  const x264PresetOptions = useMemo119(() => {
    return BrowserSafeApis3.x264PresetOptions.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: x264Preset === option ? /* @__PURE__ */ jsx236(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        value: option
      };
  ...
  const hardwareAccelerationValues = useMemo119(() => {
    return BrowserSafeApis3.hardwareAccelerationOptions.map((option) => {
      return {
        label: option,
        onClick: () => setHardwareAcceleration(option),
        leftItem: hardwareAcceleration === option ? /* @__PURE__ */ jsx236(Checkmark, {}) : null,
        subMenu: null,
        quickSwitcherLabel: null,
        type: "item",
        id: option,
  ...
  const changeOffthreadVideoThreads = useCallback113((cb) => {
  ...
  return /* @__PURE__ */ jsxs117("div", {
    ...
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: [
      renderMode === "still" ? null : /* @__PURE__ */ jsx236(NumberSetting, {
        min: minConcurrency,
        max: maxConcurrency,
        step: 1,
        name: "Concurrency",
      ...
      renderMode === "video" && codec === "h264" ? /* @__PURE__ */ jsxs117("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx236("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx236(Combobox, {
              title: x264Preset,
      ...
      renderMode === "audio" || offthreadVideoCacheSizeInBytes === null ? null : /* @__PURE__ */ jsx236(NumberSetting, {
        min: 0,
        max: 2000 * 1024 * 1024,
        step: 1024,
      ...
      renderMode === "audio" || offthreadVideoThreads === null ? null : /* @__PURE__ */ jsx236(NumberSetting, {
        min: 0,
        max: 16,
        step: 1,
      ...
      userAgent === null ? null : /* @__PURE__ */ jsxs117("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx236("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx236("div", {
              children: /* @__PURE__ */ jsx236(RemotionInput, {
                style: input,
                value: userAgent,
      ...
      /* @__PURE__ */ jsx236(RenderModalHr, {}),
      /* @__PURE__ */ jsx236(RenderModalEnvironmentVariables, {
        envVariables,
        setEnvVariables
      })
    ]
...
import { jsx as jsx237, jsxs as jsxs118 } from "react/jsx-runtime";
var EnforceAudioTrackSetting = ({ enforceAudioTrack, muted, setEnforceAudioTrack }) => {
  const onEnforceAudioTrackChanged = useCallback114((e) => {
...
import { jsx as jsx238, jsxs as jsxs119 } from "react/jsx-runtime";
var MutedSetting = ({ muted, setMuted, enforceAudioTrack }) => {
  const onMutedChanged = useCallback115((e) => {
...
import { useCallback as useCallback116, useMemo as useMemo120 } from "react";

// src/helpers/use-file-existence.ts
import { useContext as useContext78, useEffect as useEffect73, useRef as useRef39, useState as useState77 } from "react";
var useFileExistence = (outName) => {
  const [exists, setExists] = useState77(false);
...
import { jsx as jsx239, jsxs as jsxs120, Fragment as Fragment37 } from "react/jsx-runtime";
var RenderModalOutputName = ({
  ...
  return /* @__PURE__ */ jsxs120("div", {
    style: optionRow,
    children: [
      /* @__PURE__ */ jsx239(Column, {
        children: /* @__PURE__ */ jsx239("div", {
          style: label5,
          children: labelText
        })
      }),
          ...
          children: [
            ...
            validationMessage ? /* @__PURE__ */ jsxs120(Fragment37, {
              children: [
                ...
                /* @__PURE__ */ jsx239(ValidationMessage, {
                  align: "flex-end",
...
// src/components/RenderModal/SeparateAudioOption.tsx
import { jsx as jsx240, jsxs as jsxs121, Fragment as Fragment38 } from "react/jsx-runtime";
var SeparateAudioOptionInput = ({ separateAudioTo, setSeparateAudioTo, audioCodec }) => {
  ...
  const validationMessage = useMemo120(() => {
  ...
  return /* @__PURE__ */ jsx240(RenderModalOutputName, {
    existence,
    inputStyle: input,
    onValueChange,
...
var SeparateAudioOption = ({ separateAudioTo, setSeparateAudioTo, audioCodec, outName }) => {
  const onSeparateAudioChange = useCallback116((e) => {
    if (e.target.checked) {
  ...
  return /* @__PURE__ */ jsxs121(Fragment38, {
    children: [
      ...
      separateAudioTo === null ? null : /* @__PURE__ */ jsx240(SeparateAudioOptionInput, {
        separateAudioTo,
        setSeparateAudioTo,
        audioCodec
      })
...
// src/components/RenderModal/RenderModalAudio.tsx
import { jsx as jsx241, jsxs as jsxs122, Fragment as Fragment39 } from "react/jsx-runtime";
var container53 = {
  flex: 1,
  overflowY: "auto"
};
var RenderModalAudio = ({
  ...
  const onShouldHaveTargetAudioBitrateChanged = useCallback117((e) => {
    setShouldHaveCustomTargetAudioBitrate(e.target.checked);
  }, [setShouldHaveCustomTargetAudioBitrate]);
  const onTargetAudioBitrateChanged = useCallback117((e) => {
    setCustomTargetAudioBitrateValue(e.target.value);
  }, [setCustomTargetAudioBitrateValue]);
  const onSeamlessAacConcatenationChanges = useCallback117((e) => {
    setForSeamlessAacConcatenation(e.target.checked);
  }, [setForSeamlessAacConcatenation]);
  const audioCodecOptions = useCallback117((currentCodec) => {
    return BrowserSafeApis5.supportedAudioCodecs[currentCodec].map((audioCodecOption) => {
      return {
        ...
        leftItem: codec === audioCodecOption ? /* @__PURE__ */ jsx241(Checkmark, {}) : null,
        id: audioCodecOption,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  return /* @__PURE__ */ jsxs122("div", {
    ...
    children: [
        ...
        children: [
          /* @__PURE__ */ jsxs122("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx241(OptionExplainerBubble, {
                id: "audioCodecOption"
              })
            ]
          }),
          /* @__PURE__ */ jsx241("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx241(Combobox, {
      ...
      renderMode === "video" && !muted ? /* @__PURE__ */ jsx241(SeparateAudioOption, {
        separateAudioTo,
        setSeparateAudioTo,
        audioCodec,
        outName
      ...
      audioCodec === "aac" && !muted ? /* @__PURE__ */ jsxs122("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx241("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx241(Checkbox, {
              disabled: false,
      ...
      shouldHaveCustomTargetAudioBitrate && renderMode !== "still" && !muted ? /* @__PURE__ */ jsxs122("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx241("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx241("div", {
              children: /* @__PURE__ */ jsx241(RemotionInput, {
                style: input,
...
import { useCallback as useCallback120, useMemo as useMemo122 } from "react";
...
import { useCallback as useCallback118, useMemo as useMemo121 } from "react";
import { jsx as jsx242, jsxs as jsxs123 } from "react/jsx-runtime";
var container54 = {
  borderColor: "black",
  borderStyle: "solid",
  borderWidth: "2px",
...
var MultiRangeSlider = ({
  ...
  const getPercent = useCallback118((value) => Math.round((value - min) / (max - min) * 100), [min, max]);
  const rangeStyle = useMemo121(() => {
  ...
  const onChangeLeft = useCallback118((event) => {
    const value = Math.min(Number(event.target.value), end - 1);
    onLeftThumbDrag(value);
  }, [end, onLeftThumbDrag]);
  const onChangeRight = useCallback118((event) => {
...
// src/components/RenderModal/FrameRangeSetting.tsx
import { jsx as jsx243, jsxs as jsxs124 } from "react/jsx-runtime";
var INPUT_WIDTH = 40;
var FrameRangeSetting = ({ startFrame, endFrame, setEndFrame, durationInFrames, setStartFrame }) => {
  ...
  const onStartFrameChangedDirectly = useCallback119((newStartFrame) => {
    setStartFrame(newStartFrame);
  }, [setStartFrame]);
  const onEndFrameChangedDirectly = useCallback119((newEndFrame) => {
    setEndFrame(newEndFrame);
  }, [setEndFrame]);
  const onStartFrameChanged = useCallback119((newVal) => {
    onStartFrameChangedDirectly(parseInt(newVal, 10));
  }, [onStartFrameChangedDirectly]);
  const onEndFrameChanged = useCallback119((newVal) => {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs124("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx243(MultiRangeSlider, {
            min: minStartFrame,
            max: maxEndFrame,
            start: startFrame,
            end: endFrame,
...
// src/components/RenderModal/RenderModalBasic.tsx
import { jsx as jsx244, jsxs as jsxs125 } from "react/jsx-runtime";
var container55 = {
  flex: 1
};
var RenderModalBasic = ({
  ...
  const videoCodecOptions = useMemo122(() => {
    return BrowserSafeApis6.validCodecs.filter((c) => {
      ...
      return {
        ...
        key: codecOption,
        leftItem: codec === codecOption ? /* @__PURE__ */ jsx244(Checkmark, {}) : null,
        id: codecOption,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  const proResProfileOptions = useMemo122(() => {
  ...
  const onFrameSetDirectly = useCallback120((newFrame) => {
    setFrame(newFrame);
  }, [setFrame]);
  const onFrameChanged = useCallback120((e) => {
    setFrame((q) => {
  ...
  const onValueChange = useCallback120((e) => {
    setOutName(e.target.value);
  }, [setOutName]);
  const onVerboseLoggingChanged = useCallback120((e) => {
    ...
    children: [
      renderMode === "still" || renderMode === "sequence" ? /* @__PURE__ */ jsxs125("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx244("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx244(SegmentedControl, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx244("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx244(Combobox, {
      ...
      renderMode === "still" ? null : /* @__PURE__ */ jsx244(FrameRangeSetting, {
      ...
      /* @__PURE__ */ jsx244(RenderModalOutputName, {
        existence,
        inputStyle: input,
        outName,
        onValueChange,
...
import { jsx as jsx245, jsxs as jsxs126 } from "react/jsx-runtime";
var min = 0;
var NumberOfLoopsSetting = ({ numberOfGifLoops, setNumberOfGifLoops }) => {
  const onNumberOfGifLoopsChangedDirectly = useCallback121((newConcurrency) => {
    setNumberOfGifLoops(newConcurrency);
  }, [setNumberOfGifLoops]);
  const onNumberOfGifLoopsChanged = useCallback121((e) => {
  ...
  return /* @__PURE__ */ jsxs126("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx245("div", {
        style: rightRow,
        children: /* @__PURE__ */ jsx245(RightAlignInput, {
          children: /* @__PURE__ */ jsx245(InputDragger, {
...
// src/components/RenderModal/RenderModalGif.tsx
import { jsx as jsx246, jsxs as jsxs127 } from "react/jsx-runtime";
var container56 = {
  flex: 1
};
var RenderModalGif = ({
  ...
  const onShouldLimitNumberOfGifLoops = useCallback122((e) => {
    setLimitNumberOfGifLoops(e.target.checked);
  }, [setLimitNumberOfGifLoops]);
  return /* @__PURE__ */ jsxs127("div", {
    style: container56,
    children: [
      /* @__PURE__ */ jsx246(NumberSetting, {
        ...
        children: [
          /* @__PURE__ */ jsxs127("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx246(OptionExplainerBubble, {
          ...
          /* @__PURE__ */ jsx246("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx246(Checkbox, {
      ...
      limitNumberOfGifLoops ? /* @__PURE__ */ jsx246(NumberOfLoopsSetting, {
...
var ScaleSetting = ({ scale, setScale }) => {
  return /* @__PURE__ */ jsx248(NumberSetting, {
    min: MIN_SCALE,
    max: MAX_SCALE,
    step: 0.1,
    name: "Scale",
...
// src/components/RenderModal/RenderModalPicture.tsx
import { jsx as jsx249, jsxs as jsxs128, Fragment as Fragment40 } from "react/jsx-runtime";
...
var RenderModalPicture = ({
  ...
  const colorSpaceOptions = useMemo123(() => {
    return BrowserSafeApis7.validColorSpaces.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: colorSpace === option ? /* @__PURE__ */ jsx249(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        type: "item",
        value: option
  ...
  const qualityControlOptions = useMemo123(() => {
  ...
  const onTargetVideoBitrateChanged = useCallback123((e) => {
    setCustomTargetVideoBitrateValue(e.target.value);
  }, [setCustomTargetVideoBitrateValue]);
  const onEncodingBufferSizeToggled = useCallback123((e) => {
    setEncodingBufferSize(e.target.checked ? "10000k" : null);
  }, [setEncodingBufferSize]);
  const onEncodingMaxRateToggled = useCallback123((e) => {
    setEncodingMaxRate(e.target.checked ? "5000k" : null);
  }, [setEncodingMaxRate]);
  const onEncodingBufferSizeChanged = useCallback123((e) => {
    setEncodingBufferSize(e.target.value);
  }, [setEncodingBufferSize]);
  const onEncodingMaxRateChanged = useCallback123((e) => {
    ...
    children: [
      renderMode === "video" ? /* @__PURE__ */ jsxs128("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx249("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx249(SegmentedControl, {
              items: imageFormatOptions,
              needsWrapping: false
            })
          })
      ...
      renderMode === "video" && videoImageFormat === "jpeg" && /* @__PURE__ */ jsx249(JpegQualitySetting, {
        jpegQuality,
        setJpegQuality
      }),
      renderMode === "still" && stillImageFormat === "jpeg" && /* @__PURE__ */ jsx249(JpegQualitySetting, {
        jpegQuality,
        setJpegQuality
      }),
      renderMode === "video" && qualityControlType !== null ? /* @__PURE__ */ jsx249(RenderModalHr, {}) : null,
      ...
      qualityControlType === "crf" && renderMode !== "still" && renderMode !== "sequence" && crf !== null ? /* @__PURE__ */ jsx249(CrfSetting, {
        crf,
        min: minCrf,
        max: maxCrf,
        setCrf,
        ...
        children: [
          /* @__PURE__ */ jsxs128("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx249(Spacing, {
                x: 0.5
              }),
              /* @__PURE__ */ jsx249(OptionExplainerBubble, {
          ...
          /* @__PURE__ */ jsx249("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx249("div", {
              children: /* @__PURE__ */ jsx249(RemotionInput, {
                style: input,
        ...
        children: [
          /* @__PURE__ */ jsxs128("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx249("div", {
                style: rightRow,
                children: /* @__PURE__ */ jsx249(Checkbox, {
      ...
      renderMode === "video" ? /* @__PURE__ */ jsx249(RenderModalHr, {}) : null,
      /* @__PURE__ */ jsx249(ScaleSetting, {
        scale,
        setScale
      }),
      renderMode === "video" ? /* @__PURE__ */ jsx249(RenderModalHr, {}) : null,
      renderMode === "video" ? /* @__PURE__ */ jsxs128("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx249("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx249(Combobox, {
...
var RenderModal = ({
  ...
  const [unclampedFrame, setFrame] = useState78(() => initialFrame);
  const [saving, setSaving] = useState78(false);
  const [stillImageFormat, setStillImageFormat] = useState78(() => initialStillImageFormat);
  const [videoImageFormat, setVideoImageFormat] = useState78(() => initialVideoImageFormat);
  const [sequenceImageFormat, setSequenceImageFormat] = useState78(() => initialStillImageFormat === "jpeg" ? "jpeg" : "png");
  const [concurrency, setConcurrency] = useState78(() => initialConcurrency);
  const [videoCodecForVideoTab, setVideoCodecForVideoTab] = useState78(() => initialVideoCodecForVideoTab);
  const [userSelectedAudioCodec, setUserSelectedAudioCodec] = useState78(() => initialAudioCodec);
  const [separateAudioTo, setSeparateAudioTo] = useState78(null);
  const [envVariables, setEnvVariables] = useState78(() => envVariablesObjectToArray(initialEnvVariables).filter(([key5]) => key5 !== "NODE_ENV"));
  const [initialOutName] = useState78(() => {
  ...
  const [videoCodecForAudioTab, setVideoCodecForAudioTab] = useState78(() => initialVideoCodecForAudioTab);
  const [mutedState, setMuted] = useState78(() => initialMuted);
  const [repro, setRepro] = useState78(() => initialRepro);
  const [enforceAudioTrackState, setEnforceAudioTrackState] = useState78(() => initialEnforceAudioTrack);
  const [forSeamlessAacConcatenation, setForSeamlessAacConcatenation] = useState78(() => initialForSeamlessAacConcatenation);
  const [renderMode, setRenderModeState] = useState78(initialRenderType);
  const [jpegQuality, setJpegQuality] = useState78(() => initialJpegQuality);
  const [scale, setScale] = useState78(() => initialScale);
  const [logLevel, setLogLevel] = useState78(() => initialLogLevel);
  const [disallowParallelEncoding, setDisallowParallelEncoding] = useState78(false);
  const [disableWebSecurity, setDisableWebSecurity] = useState78(() => initialDisableWebSecurity);
  const [headless, setHeadless] = useState78(() => initialHeadless);
  const [beepOnFinish, setBeepOnFinish] = useState78(() => initialBeep);
  const [ignoreCertificateErrors, setIgnoreCertificateErrors] = useState78(() => initialIgnoreCertificateErrors);
  const [multiProcessOnLinux, setChromiumMultiProcessOnLinux] = useState78(() => initialMultiProcessOnLinux);
  const [openGlOption, setOpenGlOption] = useState78(() => initialGl ?? "default");
  const [colorSpace, setColorSpace] = useState78(() => initialColorSpace);
  const [userAgent, setUserAgent] = useState78(() => initialUserAgent === null ? null : initialUserAgent.trim() === "" ? null : initialUserAgent);
  const chromiumOptions = useMemo124(() => {
    return {
      headless,
      disableWebSecurity,
      ignoreCertificateErrors,
  ...
  const [startFrameOrNull, setStartFrame] = useState78(() => inFrameMark ?? null);
  const [proResProfileSetting, setProResProfile] = useState78(() => initialProResProfile);
  const [x264PresetSetting, setx264Preset] = useState78(() => initialx264Preset);
  const [hardwareAcceleration, setHardwareAcceleration] = useState78(() => initialHardwareAcceleration);
  const [userPreferredPixelFormat, setPixelFormat] = useState78(() => initialPixelFormat);
  const [preferredQualityControlType, setQualityControl] = useState78(() => initialVideoBitrate === null ? "crf" : "bitrate");
  const [
    shouldHaveCustomTargetAudioBitrate,
    setShouldHaveCustomTargetAudioBitrate
  ] = useState78(() => initialAudioBitrate !== null);
  const [customTargetAudioBitrate, setCustomTargetAudioBitrateValue] = useState78(() => initialAudioBitrate ?? "320K");
  const [customTargetVideoBitrate, setCustomTargetVideoBitrateValue] = useState78(() => initialVideoBitrate ?? "1M");
  const [encodingMaxRate, setEncodingMaxRate] = useState78(() => initialEncodingMaxRate ?? null);
  const [encodingBufferSize, setEncodingBufferSize] = useState78(() => initialEncodingBufferSize ?? null);
  const [limitNumberOfGifLoops, setLimitNumberOfGifLoops] = useState78(() => initialNumberOfGifLoops !== null);
  const [numberOfGifLoopsSetting, setNumberOfGifLoopsSetting] = useState78(() => initialNumberOfGifLoops ?? 0);
  ...
  const supportsBothQualityControls = useMemo124(() => {
    return supportsCrf && supportsVideoBitrate;
  }, [supportsCrf, supportsVideoBitrate]);
  const qualityControlType = useMemo124(() => {
  ...
  const dispatchIfMounted = useCallback124((payload) => {
    if (isMounted.current === false)
      return;
    dispatch(payload);
  }, []);
  const muted = useMemo124(() => {
    if (renderMode === "video") {
      return mutedState;
    }
    return false;
  }, [mutedState, renderMode]);
  const enforceAudioTrack = useMemo124(() => {
    if (renderMode === "video") {
  ...
  const deriveFinalAudioCodec = useCallback124((passedVideoCodec, passedAudioCodec) => {
  ...
  const setDefaultOutName = useCallback124((options) => {
  ...
  const setAudioCodec = useCallback124((newAudioCodec) => {
  ...
  const setCodec = useCallback124((newCodec) => {
    if (renderMode === "audio") {
  ...
  const setStillFormat = useCallback124((format) => {
  ...
  const onClickStill = useCallback124(() => {
    setSidebarCollapsedState({ left: null, right: "expanded" });
    persistSelectedOptionsSidebarPanel2("renders");
  ...
  const everyNthFrame = useMemo124(() => {
    if (codec === "gif") {
  ...
  const availablePixelFormats = useMemo124(() => {
    return BrowserSafeApis10.validPixelFormatsForCodec(codec);
  }, [codec]);
  const pixelFormat = useMemo124(() => {
  ...
  const onClickVideo = useCallback124(() => {
    setSidebarCollapsedState({ left: null, right: "expanded" });
    persistSelectedOptionsSidebarPanel2("renders");
    optionsSidebarTabs.current?.selectRendersPanel();
    dispatchIfMounted({ type: "start" });
  ...
  const imageFormatOptions = useMemo124(() => {
    if (renderMode === "still") {
      return [
        {
          label: "PNG",
  ...
  const setRenderMode = useCallback124((newRenderMode) => {
  ...
  const renderTabOptions = useMemo124(() => {
  ...
  const pixelFormatOptions = useMemo124(() => {
    return availablePixelFormats.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: pixelFormat === option ? /* @__PURE__ */ jsx250(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        type: "item",
        value: option
  ...
  return /* @__PURE__ */ jsxs129("div", {
    style: outer4,
    children: [
      /* @__PURE__ */ jsx250(ModalHeader, {
        title: `Render ${resolvedComposition.id}`
      }),
      /* @__PURE__ */ jsxs129("div", {
        style: container58,
        children: [
          /* @__PURE__ */ jsx250(SegmentedControl, {
      ...
      /* @__PURE__ */ jsxs129("div", {
        ...
        children: [
            ...
            children: [
              shownTabs.includes("general") ? /* @__PURE__ */ jsxs129(VerticalTab, {
                ...
                children: [
                  /* @__PURE__ */ jsx250("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx250(FileIcon, {
                      style: icon6
                    })
                  }),
                  "General"
              ...
              shownTabs.includes("data") ? /* @__PURE__ */ jsxs129(VerticalTab, {
                ...
                children: [
                  /* @__PURE__ */ jsx250("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx250(DataIcon, {
                      style: icon6
                    })
                  }),
                  "Input Props"
              ...
              shownTabs.includes("picture") ? /* @__PURE__ */ jsxs129(VerticalTab, {
                ...
                children: [
                  /* @__PURE__ */ jsx250("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx250(PicIcon, {
                      style: icon6
                    })
                  }),
                  "Picture"
              ...
              shownTabs.includes("audio") ? /* @__PURE__ */ jsxs129(VerticalTab, {
                ...
                children: [
                  /* @__PURE__ */ jsx250("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx250(AudioIcon, {
                      style: icon6
                    })
                  }),
                  "Audio"
              ...
              shownTabs.includes("gif") ? /* @__PURE__ */ jsxs129(VerticalTab, {
                ...
                children: [
                  /* @__PURE__ */ jsx250("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx250(GifIcon, {
                      style: icon6
                    })
                  }),
                  "GIF"
              ...
              shownTabs.includes("advanced") ? /* @__PURE__ */ jsxs129(VerticalTab, {
                ...
                children: [
                  /* @__PURE__ */ jsx250("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx250(GearIcon, {
                      style: icon6
                    })
                  }),
                  "Other"
          ...
          /* @__PURE__ */ jsx250("div", {
            style: optionsPanel,
            className: VERTICAL_SCROLLBAR_CLASSNAME,
            children: tab === "general" ? /* @__PURE__ */ jsx250(RenderModalBasic, {
              codec,
              resolvedComposition,
              frame: frame2,
              imageFormatOptions,
            ...
            }) : tab === "picture" ? /* @__PURE__ */ jsx250(RenderModalPicture, {
              renderMode,
              scale,
              setScale,
              pixelFormat,
              ...
              encodingMaxRate,
              setEncodingMaxRate
            }) : tab === "audio" ? /* @__PURE__ */ jsx250(RenderModalAudio, {
              muted,
              renderMode,
              setMuted,
              codec,
              ...
              setSeparateAudioTo,
              outName
            }) : tab === "gif" ? /* @__PURE__ */ jsx250(RenderModalGif, {
              everyNthFrame,
              limitNumberOfGifLoops,
              numberOfGifLoopsSetting,
              setEveryNthFrameSetting,
              setLimitNumberOfGifLoops,
              setNumberOfGifLoopsSetting
            }) : tab === "data" ? /* @__PURE__ */ jsx250(DataEditor, {
            ...
            }) : /* @__PURE__ */ jsx250(RenderModalAdvanced, {
              x264Preset,
              setx264Preset,
              concurrency,
              maxConcurrency,
...
var RenderModalWithLoader = (props) => {
  return /* @__PURE__ */ jsx250(DismissableModal, {
    children: /* @__PURE__ */ jsx250(ResolveCompositionBeforeModal, {
      compositionId: props.compositionId,
      children: /* @__PURE__ */ jsx250(RenderModal, {
        ...props
      })
    })
  });
...
import { useCallback as useCallback126, useContext as useContext80 } from "react";

// src/components/RenderModal/GuiRenderStatus.tsx
import { useCallback as useCallback125, useMemo as useMemo125 } from "react";
...
var SuccessIcon = () => {
  return /* @__PURE__ */ jsx251("svg", {
    style: iconStyle7,
    viewBox: "0 0 512 512",
    children: /* @__PURE__ */ jsx251("path", {
      fill: LIGHT_TEXT,
      d: "M256 512c141.4 0 256-114.6 256-256S397.4 0 256 0S0 114.6 0 256S114.6 512 256 512zM369 209L241 337l-17 17-17-17-64-64-17-17L160 222.1l17 17 47 47L335 175l17-17L385.9 192l-17 17z"
    })
  });
...
// src/components/RenderModal/GuiRenderStatus.tsx
import { jsx as jsx252, jsxs as jsxs130 } from "react/jsx-runtime";
var progressItem = {
  padding: 10,
  display: "flex",
  flexDirection: "row",
...
var BundlingProgress = ({ progress, doneIn }) => {
  return /* @__PURE__ */ jsxs130("div", {
    style: progressItem,
    children: [
      progress === 1 ? /* @__PURE__ */ jsx252(SuccessIcon, {}) : /* @__PURE__ */ jsx252(CircularProgress, {
        progress
      }),
      /* @__PURE__ */ jsx252(Spacing, {
        x: 1
      }),
      /* @__PURE__ */ jsx252("div", {
        style: label9,
...
var RenderingProgress = ({ progress }) => {
  return /* @__PURE__ */ jsxs130("div", {
    style: progressItem,
    children: [
      progress.frames === progress.totalFrames ? /* @__PURE__ */ jsx252(SuccessIcon, {}) : /* @__PURE__ */ jsx252(CircularProgress, {
...
var OpenFile = ({ job }) => {
  ...
  return /* @__PURE__ */ jsxs130("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx252("div", {
        style: right3,
        children: /* @__PURE__ */ jsx252(RenderQueueOpenInFinderItem, {
          job
        })
      })
    ]
...
var GuiRenderStatus = ({ job }) => {
  ...
  return /* @__PURE__ */ jsxs130("div", {
    children: [
      ...
      /* @__PURE__ */ jsx252(BundlingProgress, {
        progress: job.progress.bundling.progress,
        doneIn: job.progress.bundling.doneIn
      }),
      job.progress.rendering ? /* @__PURE__ */ jsx252(RenderingProgress, {
        progress: job.progress.rendering
      }) : null,
      job.progress.stitching ? /* @__PURE__ */ jsx252(StitchingProgress, {
        progress: job.progress.stitching
      }) : null,
      job.progress.downloads.length > 0 ? /* @__PURE__ */ jsx252(DownloadsProgress, {
        downloads: job.progress.downloads
      }) : null,
      job.status === "done" ? /* @__PURE__ */ jsx252(OpenFile, {
        job
      }) : null,
      /* @__PURE__ */ jsx252(Spacing, {
        y: 1
...
// src/components/RenderModal/RenderStatusModal.tsx
import { jsx as jsx253, jsxs as jsxs131, Fragment as Fragment41 } from "react/jsx-runtime";
var container59 = {
  padding: 20,
  maxWidth: 900,
  paddingTop: 0
...
var RenderStatusModal = ({
  ...
  const onQuit = useCallback126(() => {
    setSelectedModal(null);
  }, [setSelectedModal]);
  const onRetry = useCallback126(() => {
    const retryPayload = makeRetryPayload(job);
    setSelectedModal(retryPayload);
  }, [job, setSelectedModal]);
  const onClickOnRemove = useCallback126(() => {
    setSelectedModal(null);
    removeRenderJob(job).catch((err) => {
      showNotification(`Could not remove job: ${err.message}`, 2000);
    });
  }, [job, setSelectedModal]);
  const onClickOnCancel = useCallback126(() => {
    cancelRenderJob(job).catch((err) => {
      showNotification(`Could not cancel job: ${err.message}`, 2000);
    });
  }, [job]);
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs131("div", {
        ...
        children: [
          ...
          job.status === "done" || job.status === "running" ? /* @__PURE__ */ jsx253(GuiRenderStatus, {
            job
          }) : null,
          /* @__PURE__ */ jsx253("div", {
            style: spacer3
          ...
          /* @__PURE__ */ jsxs131("div", {
            style: buttonRow,
            children: [
              job.status === "running" ? /* @__PURE__ */ jsx253(Button, {
                onClick: onClickOnCancel,
                children: "Cancel render"
              }) : /* @__PURE__ */ jsx253(Button, {
                onClick: onClickOnRemove,
                children: "Remove render"
              }),
              /* @__PURE__ */ jsx253(Flex, {}),
              job.status === "failed" ? /* @__PURE__ */ jsx253(Button, {
                onClick: onRetry,
                children: "Retry"
              }) : null,
              /* @__PURE__ */ jsx253("div", {
...
import { useCallback as useCallback129, useMemo as useMemo127 } from "react";

// src/components/CopyButton.tsx
import { useCallback as useCallback127, useEffect as useEffect75, useState as useState79 } from "react";
import { jsx as jsx254, jsxs as jsxs132 } from "react/jsx-runtime";
var iconStyle8 = {
  width: 16,
  height: 16,
  color: "white"
...
var copyIcon = /* @__PURE__ */ jsx254("svg", {
  "aria-hidden": "true",
  focusable: "false",
  "data-prefix": "far",
  "data-icon": "clipboard",
...
var CopyButton = ({ textToCopy, label: label10, labelWhenCopied }) => {
  ...
  return /* @__PURE__ */ jsxs132(Button, {
    ...
    children: [
      copyIcon,
      /* @__PURE__ */ jsx254(Spacing, {
        x: 1.5
      }),
      " ",
      /* @__PURE__ */ jsx254("span", {
        style: labelStyle5,
...
import { useCallback as useCallback128, useMemo as useMemo126, useState as useState80 } from "react";
...
var OpenIssueButton = ({ link: link3 }) => {
  ...
  const handleClick = useCallback128(() => {
    window.open(link3, "_blank");
  }, [link3]);
  const svgFillColor = useMemo126(() => {
    return hovered ? "white" : LIGHT_TEXT;
  }, [hovered]);
  const openInEditorSvg = /* @__PURE__ */ jsx255("svg", {
    viewBox: "0 0 512 512",
    style: svgStyle4,
    children: /* @__PURE__ */ jsx255("path", {
      fill: svgFillColor,
      d: "M320 0c-17.7 0-32 14.3-32 32s14.3 32 32 32h82.7L201.4 265.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L448 109.3V192c0 17.7 14.3 32 32 32s32-14.3 32-32V32c0-17.7-14.3-32-32-32H320zM80 32C35.8 32 0 67.8 0 112V432c0 44.2 35.8 80 80 80H400c44.2 0 80-35.8 80-80V320c0-17.7-14.3-32-32-32s-32 14.3-32 32V432c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16V112c0-8.8 7.2-16 16-16H192c17.7 0 32-14.3 32-32s-14.3-32-32-32H80z"
    })
  });
  const onPointerEnter = useCallback128(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback128(() => {
    setHovered(false);
  }, []);
  return /* @__PURE__ */ jsx255("button", {
    title: buttonTooltip,
    type: "button",
    onPointerEnter,
    onPointerLeave,
...
import { jsx as jsx256, jsxs as jsxs133 } from "react/jsx-runtime";
var container60 = {
  display: "flex",
  flexDirection: "row",
  alignItems: "center"
  ...
  const bugElements = bugs.map((bug) => {
    return /* @__PURE__ */ jsxs133("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx256(OpenIssueButton, {
          link: bug.link
        })
      ]
    }, bug.description + bug.link);
  });
  return /* @__PURE__ */ jsx256("div", {
    children: bugElements
  });
};

// src/components/UpdateModal/UpdateModal.tsx
import { jsx as jsx257, jsxs as jsxs134, Fragment as Fragment42 } from "react/jsx-runtime";
var container61 = {
  padding: 20,
  paddingTop: 0
};
      ...
      /* @__PURE__ */ jsxs134("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs134(Row, {
            align: "center",
            children: [
              /* @__PURE__ */ jsx257(Flex, {
                children: /* @__PURE__ */ jsx257("pre", {
                  onClick,
                  style: code,
                  children: command
                })
...
// src/components/Modals.tsx
import { jsx as jsx258, jsxs as jsxs135, Fragment as Fragment43 } from "react/jsx-runtime";
var Modals = ({ readOnlyStudio }) => {
  ...
  return /* @__PURE__ */ jsxs135(Fragment43, {
    children: [
      ...
      modalContextType && modalContextType.type === "delete-comp" && /* @__PURE__ */ jsx258(DeleteComposition, {
        compositionId: modalContextType.compositionId
      }),
      modalContextType && modalContextType.type === "rename-comp" && /* @__PURE__ */ jsx258(RenameComposition, {
        compositionId: modalContextType.compositionId
      }),
      modalContextType && canRender && modalContextType.type === "render" && /* @__PURE__ */ jsx258(RenderModalWithLoader, {
      ...
      modalContextType && canRender && modalContextType.type === "render-progress" && /* @__PURE__ */ jsx258(RenderStatusModal, {
        jobId: modalContextType.jobId
      }),
      modalContextType && modalContextType.type === "update" && /* @__PURE__ */ jsx258(UpdateModal, {
        info: modalContextType.info,
        knownBugs: modalContextType.knownBugs
      }),
      modalContextType && modalContextType.type === "install-packages" && /* @__PURE__ */ jsx258(InstallPackageModal, {
        packageManager: modalContextType.packageManager
      }),
      modalContextType && modalContextType.type === "quick-switcher" && /* @__PURE__ */ jsx258(QuickSwitcher_default, {
        readOnlyStudio,
        invocationTimestamp: modalContextType.invocationTimestamp,
        initialMode: modalContextType.mode
      }),
      /* @__PURE__ */ jsx258(AskAiModal, {})
    ]
  });
};
...
var Editor = ({ Root, readOnlyStudio }) => {
  ...
  const [canvasMounted, setCanvasMounted] = React173.useState(false);
  const onMounted = useCallback130(() => {
  ...
  const MemoRoot = useMemo128(() => {
    return React173.memo(Root);
  }, [Root]);
  return /* @__PURE__ */ jsx259(HigherZIndex, {
    onEscape: noop,
    onOutsideClick: noop,
    children: /* @__PURE__ */ jsxs136(TimelineZoomContext, {
      children: [
        /* @__PURE__ */ jsx259(Internals60.CurrentScaleContext.Provider, {
          value,
          children: /* @__PURE__ */ jsxs136("div", {
            style: background2,
            children: [
              canvasMounted ? /* @__PURE__ */ jsx259(MemoRoot, {}) : null,
              /* @__PURE__ */ jsxs136(Internals60.CanUseRemotionHooksProvider, {
                children: [
                  /* @__PURE__ */ jsx259(EditorContent, {
                    readOnlyStudio,
                    children: /* @__PURE__ */ jsx259(TopPanel, {
                      drawRef,
                  ...
                  /* @__PURE__ */ jsx259(GlobalKeybindings, {})
                ]
              })
            ]
          })
        }),
        /* @__PURE__ */ jsx259(Modals, {
          readOnlyStudio
        }),
        /* @__PURE__ */ jsx259(NotificationCenter, {})
      ]
    })
  });
};
...
import { useCallback as useCallback131, useContext as useContext82, useMemo as useMemo129, useState as useState81 } from "react";
...
var PreviewSizeProvider = ({ children }) => {
  const [size4, setSizeState] = useState81(() => loadPreviewSizeOption());
  const [translation, setTranslation] = useState81(() => {
    return {
      x: 0,
      y: 0
    };
  ...
  const setSize = useCallback131((newValue) => {
  ...
  const previewSizeCtx = useMemo129(() => {
    return {
  ...
  return /* @__PURE__ */ jsx260(Internals61.PreviewSizeContext.Provider, {
...
import { useCallback as useCallback132, useMemo as useMemo130, useState as useState82 } from "react";
import { jsx as jsx261 } from "react/jsx-runtime";
var CheckerboardProvider = ({ children }) => {
  const [checkerboard, setCheckerboardState] = useState82(() => loadCheckerboardOption());
  const setCheckerboard = useCallback132((newValue) => {
  ...
  const checkerboardCtx = useMemo130(() => {
    return {
      checkerboard,
      setCheckerboard
    };
  }, [checkerboard, setCheckerboard]);
  return /* @__PURE__ */ jsx261(CheckerboardContext.Provider, {
...
import { useMemo as useMemo131, useState as useState83 } from "react";
import { Internals as Internals62 } from "remotion";
import { jsx as jsx262 } from "react/jsx-runtime";
var MediaVolumeProvider = ({ children }) => {
  const [mediaMuted, setMediaMuted] = useState83(() => loadMuteOption());
  const [mediaVolume, setMediaVolume] = useState83(1);
  const mediaVolumeContextValue = useMemo131(() => {
    return {
      mediaMuted,
      mediaVolume
    };
  }, [mediaMuted, mediaVolume]);
  const setMediaVolumeContextValue = useMemo131(() => {
    return {
      setMediaMuted,
      setMediaVolume
    };
  }, []);
  return /* @__PURE__ */ jsx262(Internals62.MediaVolumeContext.Provider, {
    value: mediaVolumeContextValue,
    children: /* @__PURE__ */ jsx262(Internals62.SetMediaVolumeContext.Provider, {
...
import { useMemo as useMemo132, useState as useState84 } from "react";
import { jsx as jsx263 } from "react/jsx-runtime";
var ModalsProvider = ({ children }) => {
  const [modalContextType, setModalContextType] = useState84(null);
  const modalsContext = useMemo132(() => {
    return {
      selectedModal: modalContextType,
      setSelectedModal: setModalContextType
    };
  }, [modalContextType]);
  return /* @__PURE__ */ jsx263(ModalsContext.Provider, {
    value: modalsContext,
    children
  });
};
...
import { useEffect as useEffect77, useMemo as useMemo133, useState as useState85 } from "react";
...
var SetTimelineInOutProvider = ({ children }) => {
  const [inAndOutFrames, setInAndOutFrames] = useState85(() => loadMarks());
  const setTimelineInOutContextValue = useMemo133(() => {
    return {
      setInAndOutFrames
    };
  }, []);
  ...
  return /* @__PURE__ */ jsx264(TimelineInOutContext.Provider, {
    value: inAndOutFrames,
    children: /* @__PURE__ */ jsx264(SetTimelineInOutContext.Provider, {
...
import { useCallback as useCallback133, useMemo as useMemo134, useRef as useRef41, useState as useState86 } from "react";
import { jsx as jsx265 } from "react/jsx-runtime";
var ShowGuidesProvider = ({ children }) => {
  const [guidesList, setGuidesList] = useState86(() => loadGuidesList());
  const [selectedGuideId, setSelectedGuideId] = useState86(null);
  const [hoveredGuideId, setHoveredGuideId] = useState86(null);
  const [editorShowGuides, setEditorShowGuidesState] = useState86(() => loadEditorShowGuidesOption());
  const shouldCreateGuideRef = useRef41(false);
  const shouldDeleteGuideRef = useRef41(false);
  const setEditorShowGuides = useCallback133((newValue) => {
  ...
  const editorShowGuidesCtx = useMemo134(() => {
    return {
      editorShowGuides,
      setEditorShowGuides,
      guidesList,
  ...
  return /* @__PURE__ */ jsx265(EditorShowGuidesContext.Provider, {
...
import { useCallback as useCallback134, useMemo as useMemo135, useState as useState87 } from "react";
import { jsx as jsx266 } from "react/jsx-runtime";
var ShowRulersProvider = ({ children }) => {
  const [editorShowRulers, setEditorShowRulersState] = useState87(() => loadEditorShowRulersOption());
  const setEditorShowRulers = useCallback134((newValue) => {
  ...
  const editorShowRulersCtx = useMemo135(() => {
    return {
      editorShowRulers,
      setEditorShowRulers
    };
  }, [editorShowRulers, setEditorShowRulers]);
  return /* @__PURE__ */ jsx266(EditorShowRulersContext.Provider, {
...
import { useCallback as useCallback135, useMemo as useMemo136, useState as useState88 } from "react";
import { jsx as jsx267 } from "react/jsx-runtime";
var ZoomGesturesProvider = ({ children }) => {
  const [editorZoomGestures, setEditorZoomGesturesState] = useState88(() => loadEditorZoomGesturesOption());
  const setEditorZoomGestures = useCallback135((newValue) => {
  ...
  const editorZoomGesturesCtx = useMemo136(() => {
    return {
      editorZoomGestures,
      setEditorZoomGestures
    };
  }, [editorZoomGestures, setEditorZoomGestures]);
  return /* @__PURE__ */ jsx267(EditorZoomGesturesContext.Provider, {
...
var EditorContexts = ({ children, readOnlyStudio }) => {
  return /* @__PURE__ */ jsx268(ZodProvider, {
    children: /* @__PURE__ */ jsx268(VisualControlsProvider, {
      children: /* @__PURE__ */ jsx268(PreviewServerConnection, {
        readOnlyStudio,
        children: /* @__PURE__ */ jsx268(RenderQueueContextProvider, {
          children: /* @__PURE__ */ jsx268(KeybindingContextProvider, {
            children: /* @__PURE__ */ jsx268(CheckerboardProvider, {
              children: /* @__PURE__ */ jsx268(ZoomGesturesProvider, {
                children: /* @__PURE__ */ jsx268(ShowRulersProvider, {
                  children: /* @__PURE__ */ jsx268(ShowGuidesProvider, {
                    children: /* @__PURE__ */ jsx268(PreviewSizeProvider, {
                      children: /* @__PURE__ */ jsx268(ModalsProvider, {
                        children: /* @__PURE__ */ jsx268(MediaVolumeProvider, {
                          children: /* @__PURE__ */ jsx268(PlayerInternals20.PlayerEmitterProvider, {
                            currentPlaybackRate: null,
                            children: /* @__PURE__ */ jsx268(SidebarContextProvider, {
                              children: /* @__PURE__ */ jsx268(FolderContextProvider, {
                                children: /* @__PURE__ */ jsx268(HighestZIndexProvider, {
                                  children: /* @__PURE__ */ jsx268(SetTimelineInOutProvider, {
                                    children
                                  })
                                })
                              })
...
import { jsx as jsx269, jsxs as jsxs137 } from "react/jsx-runtime";
var container62 = {
  position: "fixed",
  justifyContent: "flex-end",
  alignItems: "flex-start",
...
// src/Studio.tsx
import { jsx as jsx270, jsxs as jsxs138 } from "react/jsx-runtime";
...
var Studio = ({ rootComponent, readOnly }) => {
  ...
  return /* @__PURE__ */ jsx270(Internals64.RemotionRoot, {
    ...
    children: /* @__PURE__ */ jsxs138(EditorContexts, {
      ...
      children: [
        /* @__PURE__ */ jsx270(Editor, {
          readOnlyStudio: readOnly,
          Root: rootComponent
        }),
        readOnly ? null : createPortal(/* @__PURE__ */ jsx270(ServerDisconnected, {}), getServerDisconnectedDomElement())
      ]
    })
  });
};
...
import { useEffect as useEffect78, useState as useState89 } from "react";
import { AbsoluteFill as AbsoluteFill6 } from "remotion";
import { jsx as jsx271, jsxs as jsxs139 } from "react/jsx-runtime";
var label10 = {
  fontSize: 13,
  color: "white",
  fontFamily: "Arial, Helvetica, sans-serif"
...
var NoRegisterRoot = () => {
  const [show, setShow] = useState89(() => false);
  useEffect78(() => {
    const timeout = setTimeout(() => {
      setShow(true);
    }, 2000);
  ...
  return /* @__PURE__ */ jsxs139(AbsoluteFill6, {
    style: container63,
    children: [
      /* @__PURE__ */ jsx271("div", {
        style: label10,
...
var mountRemotionOverlay = () => {
  if (ReactDOM8.createRoot) {
    ReactDOM8.createRoot(document.getElementById("remotion-error-overlay")).render(/* @__PURE__ */ jsx272(Overlay, {}));
  } else {
    ReactDOM8.render(/* @__PURE__ */ jsx272(Overlay, {}), document.getElementById("remotion-error-overlay"));
  }
};
...
` + "This is usually because the modules which have changed " + "(and their parents) do not know how to hot reload themselves. " + "See " + hmrDocsUrl + " for more details.");
  ...
  function performReload() {
    ...
    if (window.remotion_unsavedProps) {
      showNotification("Fast refresh needs to reload the page, but you have unsaved props. Save then reload the page to apply changes.", 1000);
    } else {
      reloadUrl();
    }
  }
...
function getEventSourceWrapper() {
  ...
  if (!window.__whmEventSourceWrapper[hotMiddlewareOptions.path]) {
    window.__whmEventSourceWrapper[hotMiddlewareOptions.path] = eventSourceWrapper();
  }
...
`);
    ...
    const style11 = styles[type];
    const name = obj.name ? "'" + obj.name + "' " : "";
    const title8 = "[Fast Refresh] bundle " + name + "has " + obj[type].length + " " + type;
    if (console.group && console.groupEnd) {
      console.group("%c" + title8, style11);
      console.log("%c" + newProblems, style11);
      console.groupEnd();
    } else {
      console.log("%c" + title8 + `
	%c` + newProblems.replace(/\n/g, `
	`), style11 + "font-weight: bold;", style11 + "font-weight: normal;");
    }
  }
  return {
    cleanProblemsCache() {
...
var enableHotMiddleware = () => {
  if (typeof window === "undefined") {} else if (typeof window.EventSource === "undefined") {
...
Internals65.CSSUtils.injectCSS(Internals65.CSSUtils.makeDefaultPreviewCSS(null, "#1f2428"));
var root = null;
var getRootForElement = () => {
  if (root) {
    return root;
  }
  root = ReactDOM9.createRoot(Internals65.getPreviewDomElement());
  return root;
};
var renderToDOM = (content7) => {
  if (!ReactDOM9.createRoot) {
    ...
    ReactDOM9.render(content7, Internals65.getPreviewDomElement());
    return;
  }
  getRootForElement().render(content7);
};
renderToDOM(/* @__PURE__ */ jsx273(NoRegisterRoot, {}));
Internals65.waitForRoot((NewRoot) => {
  renderToDOM(/* @__PURE__ */ jsx273(Studio, {
    readOnly: false,
